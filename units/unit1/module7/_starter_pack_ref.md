...
- Can student state the structure as "X groups of Y"?
- Can student distinguish groups from items-per-group (not reversing)?
...
<tr>
<td>Building On</td>
<td>2.OA.C.3: Work with equal groups of objects to gain foundations for multiplication.</td>
</tr>
<tr>
<td></td>
<td>2.NBT.B.5: Fluently add and subtract within 100. (skip-counting fluency)</td>
</tr>
<tr>
<td>**Addressing**</td>
...
<tr>
<td></td>
<td>3.OA.A.3: Use multiplication within 100 to solve word problems involving equal groups.</td>
</tr>
</table>
...
<td>Lesson</td>
<td>Topic</td>
<td>Curriculum Reference</td>
</tr>
<tr>
<td>L9</td>
<td>Build an understanding of multiplication as equal groups</td>
<td>Foundational concept</td>
</tr>
<tr>
<td>L10</td>
<td>Interpret equal groups situations and represent them</td>
<td>Interpretation skill</td>
</tr>
</table>
---
...
<tr>
<td>Tape diagrams</td>
<td>Instructional overhead exceeds value at this stage</td>
<td>Deferred (not in Unit 1 scope)</td>
</tr>
<tr>
...
<tr>
<td>Factor/factor terminology</td>
<td>Premature; students learning "groups of"</td>
<td>M9</td>
</tr>
<tr>
<td>Arrays</td>
<td>Different spatial structure</td>
<td>M11</td>
</tr>
<tr>
...
<td>M7 is structure recognition, not calculating</td>
...
**Instructional Vocabulary (used to teach, not assessed):** groups of, in each group, how many groups, how many in each
**M7 Structural Language (scaffolding phrases):**
- "How many groups?"
...
<tr>
<td>**Warmup**</td>
<td>"groups of," "equal groups," "multiplication"</td>
<td>Bridge reveal: "4 symbols, each = 5. That's 4 GROUPS of 5. This is called MULTIPLICATION." Named AFTER visual experience.</td>
</tr>
<tr>
...
<td>(All terms)</td>
<td>Apply to new context (circles). Reinforce language with lighter scaffolding.</td>
</tr>
<tr>
...
<td>(All terms)</td>
<td>Recognition tasks + mixed contexts. Student uses vocabulary in MC selections.</td>
</tr>
<tr>
<td>**Exit Check**</td>
<td>(All terms minus "product")</td>
<td>Use in question contexts. Focus on structure, not terminology recall.</td>
</tr>
<tr>
<td>**Synthesis**</td>
<td>(All terms)</td>
<td>Consolidation. Student connects equal groups across contexts.</td>
</tr>
</table>
...
- Without explicit instruction, students may default to saying the larger number first
- No prior framework for distinguishing roles of two numbers in an operation (addition is commutative, so order didn't matter before)
**Prevention Strategy:**
...
- Some prior instruction may have introduced multiplication exclusively through repeated addition
...
---
### 1.4.3 #18: Skip Counting Without Meaning (TERTIARY)
**Trigger Behavior:** Student can skip-count by 5s (5, 10, 15, 20) but cannot explain what the numbers mean in a groups context. When shown 4 bags with 5 items each and asked "How many items altogether?", student skip-counts but cannot make the connection to "4 groups of 5."
**Why It Happens:**
- Skip-counting was taught procedurally in M1-M6 without deliberate connection to equal groups
- Procedure â‰  meaning. Student has automaticity but no conceptual anchor
- M7's task is explicitly to CREATE that connection
**Prevention Strategy:**
1. **Name skip-counting as equal groups counting:** Warmup Interaction W.2 makes this explicit: "4 symbols. Each one = 5 items. So we're skip-counting by 5. 5, 10, 15, 20. That's 4 groups of 5."
2. **Highlight the connection during Warmup bridge:** Guide explicitly states, "You've been skip-counting all along. That's equal groups counting."
3. **Reinforce in Lesson Section 1 worked examples:** When demonstrating 3 bags with 4 items each, Guide says, "Skip-counting by 4s: 4, 8, 12. That's what 3 groups of 4 is."
**Remediation Approach:**
...
<tr>
<td>**Primary containers**</td>
<td>Bags (drawn outlines with openable tops), boxes (drawn rectangles), circles (outlined, unfilled)</td>
</tr>
<tr>
<td>**Item types**</td>
<td>Dots (default), markers (Exit Check), juice boxes (Synthesis)</td>
</tr>
<tr>
...
<td>Two-step guided sequence: (Step 1) Set container count via UI slider or increment button. (Step 2) Set items-per-container via second UI. Both steps must be present; single-step building forbidden. Used in Lesson (1.3, 1.4, early sections) and Exit Check (EC.2) and Synthesis (S.3).</td>
</tr>
<tr>
<td>**Abstraction levels**</td>
<td>Concrete: Bags and boxes (recognizable containers). Semi-abstract: Circles (generic containers, no real-world correspondence).</td>
</tr>
<tr>
<td>**Data range**</td>
<td>2-5 groups; 2-6 items per group. Total products not exceeding 30. Values intentionally varied (not sequential) to ensure students are identifying structure, not pattern-matching numbers.</td>
</tr>
</table>
### M7 Guardrails
<table header-row="true">
...
<tr>
<td>**Build Mode sequence**</td>
<td>ALWAYS: Set groups first, then items per group. Never reverse.</td>
</tr>
<tr>
<td>**Single-step building forbidden**</td>
<td>Both steps (groups, items) must be visible and required. One-step UI not permitted.</td>
</tr>
<tr>
<td>**Container type consistency within phase**</td>
<td>Lesson Section 1 uses bags/boxes exclusively (concrete). Section 2 uses circles exclusively (semi-abstract). Section 3 mixes them. This prevents abstraction levels from confusing the primary learning.</td>
</tr>
<tr>
<td>**Same context not repeated at same cognitive level**</td>
<td>E.g., "3 groups of 4 in bags" appears in Lesson 1.2 (identify from visual). The same context cannot appear again as a Build Mode task (different cognitive type) without explicit intent noted in the design.</td>
</tr>
<tr>
<td>**No mixing of container types within a single interaction**</td>
<td>A single interaction cannot show 2 bags and 3 circles simultaneously. Container types change BETWEEN interactions, not within.</td>
</tr>
<tr>
<td>**Highlight Mode (if used) is preview only**</td>
<td>When Guide uses Highlight Mode (e.g., "Let me show you how one bag opens"), it's a non-interactive preview. Next interaction is always BUILD or IDENTIFY, not another Highlight.</td>
</tr>
</table>
...
<tr>
<td>**Two-step structure non-negotiable**</td>
<td>Step 1: "How many groups?" Step 2: "How many in each group?" Both must appear.</td>
</tr>
<tr>
<td>**First step: set groups**</td>
<td>Student action: Set container count. UI presents slider (2-6) or increment buttons. Must be explicit that this number is GROUPS.</td>
</tr>
<tr>
<td>**Second step: set items**</td>
<td>Student action: Set items-per-container. UI presents slider (2-6) or increment buttons. Must be explicit that this number is ITEMS IN EACH.</td>
</tr>
<tr>
<td>**Validation per step**</td>
<td>Step 1 validation: Container appears. Step 2 validation: Items populate. Do NOT show full result until both steps complete.</td>
</tr>
<tr>
<td>**Feedback language**</td>
<td>On Correct (Step 1): "2 groups" (names the count). On Correct (Step 2): "2 groups, 3 in each" (names both components). Feedback includes "groups" and "in each" language.</td>
</tr>
<tr>
...
<tr>
<td>**Visual format**</td>
<td>Horizontal bar graph. Single category. Symbols represent scaled quantity (scale of 5: each symbol = 5 items).</td>
</tr>
<tr>
<td>**Scales used**</td>
<td>Scale of 5 only (matching M6 closure and student prior knowledge). No scale-of-2 or scale-of-10 in M7.</td>
</tr>
<tr>
<td>**Interaction**</td>
<td>Reading mode only. Student reads the graph. Guide shows it, student observes. No graph creation, no scale-setting by student.</td>
</tr>
<tr>
...
<tr>
<td>**Product range**</td>
<td>All M7 interactions use products â‰¤ 30. This matches typical Grade 3 "within 30" computational scope and keeps cognitive load on structure, not computation.</td>
</tr>
<tr>
...
<td>Some values appear in multiple sections deliberately (e.g., "3 groups of 4" in Lesson 1.2 and 1.5) to show same structure across abstraction levels. But cognitive TYPE must differ (Section 1 = identify; Section 2 = identify with reduced support; Section 3 = MC recognition). This is pedagogically sound "review with new demand."</td>
</tr>
<tr>
...
---
## 1.6 WARMUP
**Detail Level:** Dialogue + parameters (AI writes interaction details)
### Purpose
Bridge M6's success with scaled graphs into M7's equal groups revelation. Students re-engage with their graph-reading skill (high success chance) and discover that the scales they've been interpreting were EQUAL GROUPS all along. This reframing is the conceptual aha of M7. Warmup ends with students eager to explore equal groups in new contexts.
### Parameters
<table header-row="true">
<tr>
<td>Element</td>
...
<tr>
<td>**Interactions**</td>
<td>3 meaningful interactions + bridge</td>
</tr>
<tr>
<td>**Toy**</td>
...
<tr>
<td>**Scaffolding**</td>
<td>High at start (reading familiar graphs), fading to independence (bags without support)</td>
</tr>
<tr>
<td>**Remediation**</td>
<td>Light only (if errors on graph reading, redirect to prior M6 routine)</td>
</tr>
<tr>
<td>**Energy**</td>
<td>Build anticipation without teaching; discovery rather than instruction</td>
</tr>
</table>
### Constraints
<table header-row="true">
...
<tr>
<td>Quick success with graph reading</td>
<td>Introduce new graph scales or formats</td>
</tr>
<tr>
<td>Bridge reveal language ("That's groups")</td>
...
<td>Stay in one context</td>
</tr>
<tr>
<td>End with genuine curiosity ("Let's see...")</td>
<td>Over-promise or teach ahead</td>
</tr>
</table>
### Warmup Interactions
...
- **Guide:** "4 symbols. Each symbol held 5 items. That's 4 groups of 5. Look familiar? This is called MULTIPLICATION. You've been doing multiplication this whole time."
...
**Structure:**
- [ ] Exactly 3 interactions + bridge
- [ ] Opens with high-success familiar task (graph reading)
- [ ] Reveals equal groups via animation (Interaction W.2)
- [ ] Tests transfer to non-graph context (Interaction W.3)
- [ ] Bridge creates anticipation without teaching (Interaction W.4)
...
- [ ] W.2 emphasizes "containers holding groups" language (concrete anchoring for #10)
- [ ] No repeated addition language (prevents #11)
---
...
<tr>
<td>**Lesson Section 1**</td>
<td>"Here are three bags. Open one. How many are inside? Now count the bags. That's equal groups."</td>
...
<tr>
<td>**Lesson Section 2**</td>
<td>Repeat structure with reduced scaffolding (Guide less present). Introduction of "product" vocabulary.</td>
...
<tr>
<td>**Lesson Section 3**</td>
<td>MC tasks: "Which expression shows this?" Four options (correct, reversed #10, addition #11, addition + reversed).</td>
<td>Expression matching (notation â†” visual)</td>
</tr>
</table>
### Lesson Structure
<table header-row="true">
...
<tr>
<td>Section 3</td>
<td>Recognition Tasks & Mixed Contexts</td>
<td>3 interactions</td>
<td>MC expression selection; abstraction level independence</td>
</tr>
</table>
---
...
- **Prompt Step 1:** "How many groups? Set the bags."
- **Student Action:** Set container count to 3 (UI slider or increment).
- **Correct Answer:** 3 bags appear.
- **On Correct:** "3 groups."
- **Remediation:** Pipeline
> **Remediation Note:** If student reverses the order (sets 4 instead of 3), target the misconception: "3 GROUPS means 3 containers. The second number (4) goes inside each one."
- **Prompt Step 2:** "How many in each group? Add the items."
- **Student Action:** Set items-per-container to 4 (UI slider or increment).
- **Correct Answer:** 4 items appear in each bag.
...
- **Visual: Context Visualizations.** 3 circles, each with 3 dots.
- **Guide:** "Here are more circles. What do you notice?"
- **Prompt:** "How many groups? How many in each?"
...
Ensure these critical phrases appear in the Lesson dialogue and scripts:
...
---
### 1.7.6 Misconception Prevention
<table header-row="true">
<tr>
<td>Misconception</td>
<td>Prevented By</td>
<td>Lesson Evidence</td>
</tr>
<tr>
<td>#10 (Groups vs. Size Confusion)</td>
<td>Consistent two-step routine: "How many groups?" ALWAYS first. Visual highlighting of groups. Language "Groups first."</td>
<td>Section 1 Interactions 1.1-1.2; Error feedback in 1.5, 3.1-3.3</td>
</tr>
<tr>
<td>#11 (Multiplication Only Adds)</td>
<td>"Groups of" language, not "add these." Concrete visuals emphasize containers.</td>
<td>Throughout Section 1-2 Guide dialogue and prompts</td>
</tr>
<tr>
<td>#18 (Skip Counting Without Meaning)</td>
<td>Warmup Interaction W.2 explicit connection: "4 groups of 5, skip-counting by 5s." Lesson Section 2.3 callback to graphs.</td>
<td>Warmup W.2 and Lesson Interaction 2.3</td>
</tr>
</table>
---
## 1.7.7 Success Criteria
By the end of Lesson, student demonstrates:
...
### Purpose
Assess whether students have internalized the learning from Warmup and Lesson. Three problems test: (EC.1) identifying groups and items from a concrete visual; (EC.2) building equal groups via Build Mode; (EC.3) selecting the correct expression from MC. Problems are carefully aligned to Lesson content but use different values to prevent rote recall. Low-stakes tone; brief closure transitions to Practice.
### Parameters
<table header-row="true">
<tr>
<td>Element</td>
...
<td>IDENTIFY (EC.1), CREATE (EC.2), IDENTIFY (EC.3)</td>
</tr>
<tr>
<td>**Remediation**</td>
...
<tr>
<td>**Tone**</td>
<td>Supportive, low-stakes; "Let's see what you know" not "This is a test"</td>
</tr>
</table>
### Constraints
<table header-row="true">
...
<td>Use complex scaffolding in remediation</td>
</tr>
<tr>
<td>Use MC expression recognition with four options</td>
<td>Introduce new visual models or containers</td>
</tr>
<tr>
<td>Test both concrete and semi-abstract</td>
<td>Exceed 4 minutes total time</td>
</tr>
<tr>
<td>Use values within product range of â‰¤ 30</td>
<td>Repeat exact Lesson interactions</td>
</tr>
</table>
---
### 1.8.1 Alignment Check
<table header-row="true">
<tr>
<td>Problem</td>
...
<td>EC.1</td>
<td>IDENTIFY</td>
<td>Count groups and items per group from concrete visual; describe as "X groups of Y"</td>
<td>Section 1: Interactions 1.2, 1.5</td>
</tr>
<tr>
<td>EC.2</td>
<td>CREATE</td>
<td>Build equal groups via Build Mode (two-step)</td>
<td>Section 1: Interactions 1.3, 1.4</td>
</tr>
<tr>
<td>EC.3</td>
<td>IDENTIFY</td>
...
---
### 1.8.2 Exit Check Problems
**Problem EC.1: Identify Groups and Items (IDENTIFY)**
- **Visual:** Context Visualizations. 3 boxes, 5 markers in each box.
- **Guide:** "Look at these boxes. Tell me what you see."
- **Prompt:** "How many groups? How many in each group?"
- **Student Action:** Identify groups and items (independently or with light support).
- **Correct Answer:** 3 groups, 5 in each.
- **Answer Rationale:**
	- 5 = Correct (5 markers in each box)
	- 3 = Error: Said number of groups instead of items per group (#10 confusion)
	- 8 = Error: Added groups + items
	- 15 = Error: Said total items instead of items per group
- **On Correct:** "5 markers in each box. 3 groups of 5."
- **On Incorrect:** "Look inside ONE box. Count the markers."
- **Remediation:** Pipeline
**Alignment:** Tests same skill as Lesson 1.2 and 1.5 (identify groups and items per group from concrete visual using two-step routine). Uses boxes (Lesson context) with a new item (markers) and value combination.
---
**Problem EC.2: Build Equal Groups (CREATE)**
- **Visual:** Build Mode interface. Empty workspace.
- **Guide:** "Build this one."
...
- [ ] Closure statement present
- [ ] Total time 3-4 minutes
**Alignment:**
- [ ] EC.1 tests identification of groups/items (Lesson Section 1: Interactions 1.2, 1.5)
- [ ] EC.2 tests Build Mode construction (Lesson Section 1: Interactions 1.3, 1.4)
...
- [ ] Values within Lesson range; no exact Lesson repeats as same cognitive type
- [ ] Difficulty matches Lesson (not harder, not easier)
---
---
## 1.8.5 Practice Phase Inputs
Students who exit the main Lesson with mastery move to Practice Phase, which is designed as extended, lower-stakes repetition of the Lesson's core skill (structure recognition via two-step routine and MC expression selection) across varied contexts. Practice Phase Parameters are managed separately (see Practice section); the Exit Check verifies readiness for Practice.
---
## 1.9 SYNTHESIS
...
<tr>
<td>**Interactions**</td>
<td>4 (3 connection tasks + 1 metacognitive reflection)</td>
</tr>
<tr>
<td>**Task Types**</td>
...
<tr>
<td>**Energy**</td>
<td>Medium (not exhausted, not high-energy)</td>
</tr>
</table>
### Constraints
<table header-row="true">
...
<tr>
<td>Connection tasks (pattern, transfer, real-world)</td>
<td>More practice problems</td>
</tr>
<tr>
<td>Name principles students discovered</td>
<td>Introduce new procedures</td>
</tr>
<tr>
<td>Show same concept across representations</td>
...
<tr>
<td>Brief Build Mode for real-world transfer</td>
<td>Extended Build Mode sequences (that's Practice)</td>
</tr>
<tr>
<td>Light remediation if needed</td>
<td>Extended teaching or heavy remediation</td>
</tr>
<tr>
<td>Specific identity closure</td>
...
<tr>
<td>Use Context Visualizations + Picture Graph from Lesson/Warmup</td>
<td>Introduce bar graphs or new graph types</td>
</tr>
<tr>
<td>Bridge to M8 (expression production) in closure</td>
<td>Teach expression writing (M8 content)</td>
</tr>
</table>
---
### 1.9.1 Opening Frame
...
- **Guide:** "Three different pictures. Take a look at each one. What do all three pictures show?"
- **Prompt:** "What do all three pictures show?"
- **Student Action:** Select: A) 3 groups of 5, B) 5 groups of 3, C) 3 + 5, D) 15 things with no groups
- **Correct Answer:** A (3 groups of 5)
- **Answer Rationale:**
	- A) 3 groups of 5 = Correct. All three show 3 containers/symbols with 5 items/value each.
...
- **Guide:** "Can you build what the shelf looks like?"
- **Prompt Step 1:** "How many groups? Set the packs."
...
- [ ] 3 connection tasks + 1 metacognitive reflection (5-6 min total)
...
Each section introduces ONE new demand: Section 1 = new context type (bags), Section 2 = new visual level (circles), Section 3 = new cognitive demand (expression recognition). No double-duty.
### KDD 6: Broader Factor Ranges
M7 uses varied factors (2-5 groups, 2-6 items) because it teaches STRUCTURE, not computation. Factor-specific fluency is M9.
### KDD 7: No Commutativity
M7 explicitly teaches first number = groups, second = items per group. This MUST be consistent before M12 proves they're interchangeable.
