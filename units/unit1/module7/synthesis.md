...
| **Task Types** | Type A (Pattern Discovery), Type D (Representation Transfer), Type C (Real-World Bridge — ACTIVE: Build Mode) |
...
| Show same concept across representations | Introduce new visual models or contexts |
| Use "equal groups," "groups of," × notation | Introduce "factor," "array," "row," "column" (later modules) |
| Brief Build Mode for real-world transfer | Extended Build Mode sequences (that's Practice) |
...
| Use Context Visualizations + Picture Graph from Lesson/Warmup | Introduce bar graphs or new graph types |
| Bridge to M8 (expression production) in closure | Teach expression writing (M8 content) |
---
### 1.9.1 Opening Frame
