...
| **Toy** | Picture Graphs (scale-of-5 reading) â†’ Context Visualizations (bags, boxes) progression |
| **Scaffolding** | High at start (reading familiar graphs), fading to independence (bags without support) |
| **Remediation** | Light only (if errors on graph reading, redirect to prior M6 routine) |
| **Energy** | Build anticipation without teaching; discovery rather than instruction |
### Constraints
| DO | DO NOT |
| --- | --- |
| Quick success with graph reading | Introduce new graph scales or formats |
| Bridge reveal language ("That's groups") | Teach groups/multiplication formally (Lesson does this) |
| Show Ã— symbol ONCE in final bridge | Use Ã— in earlier interactions |
| Transition from familiar (graphs) to novel (bags) | Stay in one context |
| End with genuine curiosity ("Let's see...") | Over-promise or teach ahead |
### Warmup Interactions
