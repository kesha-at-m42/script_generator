...
### Pedagogical Flow
| Phase | Student Experience | Cognitive Demand |
| --- | --- | --- |
| **Warmup → Lesson Bridge** | Transition from discovery ("Multiply what?") to application ("Show me equal groups in pictures") | High emotion, low cognitive demand |
| **Lesson Section 1** | "Here are three bags. Open one. How many are inside? Now count the bags. That's equal groups." | Concrete visual + two-step routine = structure recognition |
| **Section 1 → Section 2 Bridge** | "Circles instead of bags. Same thinking. How many groups? How many in each?" | Transfer of routine to new context |
| **Lesson Section 2** | Repeat structure with reduced scaffolding (Guide less present). Introduction of "product" vocabulary. | Same cognitive structure, fading support |
| **Section 2 → Section 3 Bridge** | "You described them as '3 groups of 4.' That can be written as 3 × 4. Look at the expression. Does it match the picture?" | Introduction of notation recognition |
| **Lesson Section 3** | MC tasks: "Which expression shows this?" Four options (correct, reversed #10, addition #11, addition + reversed). | Expression matching (notation â†” visual) |
### Lesson Structure
| Section | Focus | Interactions | New Demand |
| --- | --- | --- | --- |
| Section 1 | Concrete (Bags/Boxes) — Structure & Language | 5 interactions | Two-step routine (groups, items), language "X groups of Y" |
| Section 2 | Semi-Abstract (Circles) — Transfer & Fading | 3 interactions | Same routine, reduced scaffolding; "product" intro; graph callback |
| Section 3 | Recognition Tasks & Mixed Contexts | 3 interactions | MC expression selection; abstraction level independence |
---
...
| Misconception | Prevented By | Lesson Evidence |
| --- | --- | --- |
| #10 (Groups vs. Size Confusion) | Consistent two-step routine: "How many groups?" ALWAYS first. Visual highlighting of groups. Language "Groups first." | Section 1 Interactions 1.1-1.2; Error feedback in 1.5, 3.1-3.3 |
| #11 (Multiplication Only Adds) | "Groups of" language, not "add these." Concrete visuals emphasize containers. | Throughout Section 1-2 Guide dialogue and prompts |
| #18 (Skip Counting Without Meaning) | Warmup Interaction W.2 explicit connection: "4 groups of 5, skip-counting by 5s." Lesson Section 2.3 callback to graphs. | Warmup W.2 and Lesson Interaction 2.3 |
---
