...
---
  ...
  ### Properties
  - **Toytorial**: false — students are introduced to this toy in Module 6
...
---
  ...
  **Rectangle Bar with shaded sections:**
  ...
  ### Allowed Student Actions
  - **Cut**: Divide the whole Bar into intervals. For example, divide this Bar into thirds. Undo: click the cut line again to remove it.
  - **Select**: Select Rectangle Bars (1 or more) that match the question requirements. For example, select the Bar showing fifths. Undo: click the selected Bar again to deselect it.
  - **Shade**: Select sections to shade or unshade. For example, shade 2/3 of the Bar. Undo: click the shaded section again to unshade it.
