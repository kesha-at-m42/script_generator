...
SAMPLE_QUESTIONS = {
    "questions": [
        ...
        },
        {
            ...
            "visual_context": "A horizontal rectangle bar, unpartitioned, solid color",
        ...
        {
            "id": 3,
            "question_text": "A baker cuts a rectangle cake. Are these equal parts or unequal parts?",
            "interaction_type": "Multiple Choice",
            "difficulty_level": 3,
            "question_type": "transfer",
            "cognitive_verb": "apply",
            "visual_context": "A rectangle cake divided into 5 pieces with varying widths (2 narrow, 1 very wide, 2 medium)",
