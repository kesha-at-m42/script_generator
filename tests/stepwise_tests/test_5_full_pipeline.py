...
def test_full_pipeline(
    module_number=None, path_letter=None, num_questions=8, limit_sequences=None, output_dir=None
):
    """
    ...
    try:
        ...
        print(f"\n✗ Step 1 Error: {e}")
        outputs["steps"]["step1_questions"] = {"status": "failed", "error": str(e)}
        return outputs
    ...
    try:
        ...
        print(f"\n✗ Step 2 Error: {e}")
        outputs["steps"]["step2_sequences"] = {"status": "failed", "error": str(e)}
        return outputs
    ...
    try:
        ...
        print(f"\n✗ Step 3 Error: {e}")
        outputs["steps"]["step3_remediation"] = {"status": "failed", "error": str(e)}
        return outputs
    ...
    try:
        ...
        print(f"\n✗ Step 4 Error: {e}")
        outputs["steps"]["step4_godot"] = {"status": "failed", "error": str(e)}
        return outputs
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run full pipeline from module to Godot-ready JSON"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-l", "--limit", type=int, help="Limit sequences in remediation/Godot steps (for testing)"
    )
