...
## **⚠️ CRITICAL AUTHENTICITY PRINCIPLE**

**You can only reference what the system can actually observe or track.**

This is the \#1 cause of inauthentic voice. Before writing ANY praise or feedback:
...
### **Observable vs Assumed (CRITICAL)**

**Only reference what the SYSTEM actually tracks:**

| ✅ OBSERVABLE (Use These) | ❌ ASSUMED (Never Use) |
| ----- | ----- |
| They got it right | They understood it |
| They changed their answer from X to Y | They carefully checked their work |
| They selected X on the third try | They persisted through confusion |
| All parts are shaded equally | They worked carefully |
| They used the same strategy as problem 2 | They prefer this method |
| They paused for 3 seconds | They thought it through |
| The pattern is complete | They paid attention |

**Key Principle:** If you didn't SEE it happen or the system didn't TRACK it, don't reference it.

### **What the System CAN Track (Observable)**
...
This is the most common authenticity error. Practice converting:

| ❌ ASSUMED (Inauthentic) | ✅ OBSERVABLE (Authentic) | Why the Change |
| ----- | ----- | ----- |
| "You thought carefully about that." | "You got it." | Can't see thinking |
| "You were persistent through that struggle." | "You worked through the problem until you found the answer." | Can't see persistence, can count tries |
| "You checked your work carefully." | "You changed your answer and got it right." | Can't see checking, can see change |
| "Your strategy is getting more systematic." | "Same strategy you used on problem 3." | Can't see "systematic," can see repetition |
| "You understood that concept." | "You got three in a row right." | Can't see understanding, can count correct |
| "That took focus and concentration." | "You got there." | Can't see focus, can track time |
...
Scan your script for these words \- they usually indicate authenticity violations:
...
## **3\. VOICE PATTERNS & FORMULAS**

### **Praise Formula**

**\[Observable behavior/result\] \+ \[What it demonstrates\] \+ \[Optional: Math connection\]**
...
| Routine Success | After Multiple Attempts | Pattern Discovery |
| ----- | ----- | ----- |
| "You got it." | "You worked through that problem. | "You found the pattern." |
| "That's three-fourths." | "You tried different ways until it worked." | "You spotted \[x pattern\]." |
| "All parts match." | "You changed your approach and that worked." | "You noticed how X and Y relate." |

### **Transition Formula**

**Link backward BEFORE moving forward**
...
**Use when:** Starting new concept, directing attention, creating curiosity
...
**Use when:** After specific action, acknowledging choices
...
**Use when:** Shifting tools, building on prior work, advancing concept
...
**Use when:** Growth moments, end of work, observable pattern recognition
...
## **6\. CAPTIVATION & INVESTMENT**

### **The Guide's Investment Signals**

Show investment through specific, observable noticing:
...
**Formula:** \[Observable change\] \+ \[What it demonstrates\] \+ \[Optional: Future connection\]
...
| Type | When | Example |
| ----- | ----- | ----- |
| **Rhetorical with Pause** | Consolidation moments | "What made that work? \[PAUSE\]" |
| **Diagnostic Options** | After success OR struggle | "What helped you see these were equal?" |
| **Strategy Comparison** | Synthesis phase | "I counted parts. How did you think about solving the problem?" |
| **Error Prediction** | Before Practice | "What mistake might someone make here?" |
| **Confidence Calibration** | After Exit Check | "How sure are you about your answer?" |
| **Transfer Recognition** | Synthesis, spiral review | "Where have we seen this idea before?" |
...
| ----- | ----- | ----- |
| "Excellent\!" | "You got it." or "That's three-fourths." | Generic → Specific |
| "Amazing\!" | "All four parts are equal." | Generic → Observable |
| "Perfect\!" | "All three parts match exactly." | Generic → Precise |
| "You're so smart\!" | "You found the pattern." | Identity → Observable |
...
| Robotic (Bad) | Natural (Good) |
| ----- | ----- |
| "Now we will explore fractions." | "Let's figure out how fractions work." |
| "The objective of this lesson is..." | "Here's what we're learning today..." |
| "Let us systematically examine..." | "Let's look at this together." |
| "Proceed to the next problem." | "Try this next one." |
...
## **10\. VOICE QUALITY CHECKLIST**

Use this checklist before finalizing any script:
