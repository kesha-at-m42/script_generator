...
| :---- | :---- | :---- |
| **Warm-Up** | equal, parts | Use naturally — "Are these parts equal?" No formal introduction |
...
**Visual Cue:**  
Use highlighted outlines to overlay and directly compare part sizes; show grid arrays where equal parts fill identical grid units
...
| :---- | :---- | :---- |
| **Halves** | 1×2 (tall) ✓, 2×1 (wide) ✓ | — |
| **Thirds** | 1×3 (tall) ✓, 3×1 (wide) ✓ | — |
| **Fourths** | 1×4 (tall) ✓, 4×1 (wide) ✓, 2×2 ✓ | — |
| **Sixths** | 1×6 (tall) ✓, 6×1 (wide) ✓, 2×3 ✓, 3×2 ✓ | — |
| **Eighths** | 1×8 (wide) ✓, 2×4 ✓, 4×2 ✓ | 8×1 (wide) ✗ |
...
| **Error Feedback** | Asymmetric partition shows mismatch \+ "Look at the symmetry. These sections aren't equal." |
...
* **Visual:** Three pre-partitioned rectangles (wide orientation)  
  * Rectangle A: 4 equal parts (correct)  
  * Rectangle B: 4 unequal parts (equality distractor)  
  * Rectangle C: 5 equal parts (count distractor)  
...
* **Visual:** Complete undivided grid array appears (wide orientation)  
...
* **Vocabulary:** After shading, introduce "partition": "When we divide something into equal parts like you just did, we call it PARTITIONING."
...
* **Visual:** Fresh undivided wide rectangle

  **DEMONSTRATION SEQUENCE (all three configurations, \~45 seconds):**


  **Configuration A — Vertical Cuts (1x4):**


* **Guide:** "Here's one way to partition a rectangle into four equal parts: three cuts going down."  
* \[Demo: Show bar divided into 4 vertical strips\]  
* **Guide:** "Four tall rectangles. Each one is the same size."  
    
  **Configuration B — Horizontal Cuts (4x1):**  
    
* \[CLEAR the rectangle\]  
* **Guide:** "But watch—here's another way to partition this rectangle."  
* \[Demo: Show bar divided into 4 horizontal strips\]  
* **Guide:** "Four wide rectangles. Still four equal parts."  
    
  **Configuration C — Horizontal and Vertical Cuts (2x2):**  
    
* \[CLEAR the rectangle\]  
* **Guide:** "And one more way."  
* \[Demo: Show bar divided into 2x2 grid—first make a horizontal cut and then a vertical cut  
* **Guide:** "One cut across, one cut down. Four small rectangles. Still four equal parts."  
...
* **Guide:** "Now it’s  your turn. Make four equal parts any way you want."  
* **Prompt:** "Split the rectangle into 4 equal parts."  
* **Remediation:**  
  * **Light:** "Check that you have four parts, all the same size."  
  * **Medium:** \[Visual showing grid units\] "Count the parts—are they equal?"  
...
* **Guide:** "Now, let’s shade just one part."  
* **Prompt:** "Click on one part to shade it."  
* **Remediation:** Full L-M-H (shade focus)  
...
* **Visual:** have three possible configurations (A, B, and C) on a wide rectangle with 1 part shaded  
* **Reinforcement:** "No matter HOW you cut the rectangle —tall rectangles, wide rectangles, or smaller rectangles—if you have four equal parts and shade one, it's always 1/4."

**Interaction 1.6: Partition into Thirds**

* **Visual:** New wide undivided grid array  
...
* **Visual:** Rectangle partitioned into thirds from 1.6  
...
* **Guide \[Strategy\]:** "Here's one strategy: First split the whole in half. Then split each half into three equal parts. That gives you six equal sections." \[DEMONSTRATE\]  
* **Guide:** "Give it a try."  
...
* **Guide:** "Your turn. Please partition this rectangle into eight equal parts."  
...
* **Remediation:**  
  ...
  * **Heavy:** \[Modeling\] "Let’s work through this together: First halves, then fourths, then each fourth in half makes eighths."  
...
* **Guide**: “2 parts, 4 parts, 8 parts—each time we doubled the number of parts, each piece got smaller. More parts means smaller pieces.”
...
* **Visual:** Three partitioned/shaded rectangles (1/2, 1/3, 1/4) with notation symbols inside one unit of each grid.  
* **Guide:** "You've seen how we write fractions like ½, ⅓, and ¼. A shape that shows a fraction is called a **fraction model**. Now let's practice matching symbols to their fraction models. Drag each fraction to the rectangle that matches.”  
* **Prompt:** "Match each fraction symbol to its model." \[Drag-and-drop or selection\]  
* **Remediation:** Full L-M-H  
...
* **Guide:** "Look at these fraction models. Which model shows ⅙?"  
...
* **Guide:** "You've been cutting rectangles with lines that go straight across. This shape is called a hexagon. For hexagons, we have to work differently to make our parts equal."  
* **Guide:** "See this point in the center? On hexagons, our cuts start from the center and go out to the corners, also known as vertices. It’s like the spokes on a wheel."  
* **Demo:** Show a cut being drawn from center to vertex  
* **Guide:** "Follow along with me. I start at the center, and draw out to the vertex, or corner. That's how we'll partition hexagons."  
* **Demo:** Show a second cut from center to opposite vertex, creating halves  
...
* **Prompt:** "Partition the hexagon into 2 equal parts."  
* **Remediation:**  
...
* **Prompt:** "Click on one of the two parts to shade it."  
...
* **Guide \[Strategy\]:** "Think of it like slicing a pie into three pieces: each cut goes from the center to the vertex."  
...
* **Prompt:** "Click on 1of the 3 parts to shade it."  
* **Remediation:** Full L-M-H  
* **On Correct:** "Right. One out of three equal parts: 1/3. The notation works the same way."

**Interaction 3.5: Partition Hexagon into Sixths**

* **Visual:** New hexagon  
* **Guide:** "One more. Can you make six equal parts?"  
* **Strategy:** "Remember how we made sixths on the rectangle? First halves, then thirds in each half. Let’s try partitioning the hexagon into 6 equal parts."  
...
* **Remediation:** Full L-M-H  
* **On Correct:** "That’s 1/6. You’re seeing how we partition rectangles AND hexagons into equal parts and name them with fractions."

**CROSS-SHAPE CONNECTION (embedded after final hexagon, no prompt)**

* **Visual:** Grid array showing 1/3 alongside hexagon showing 1/3  
* **Guide:** "We have different shapes, but the same fraction describes them both. 1/3 means one out of three equal parts, no matter what shape you're working with."
...
| :---- | :---- | :---- |
| Tall rectangles | 3 vertical cuts | 4 tall, narrow pieces |
| Wide rectangles | 3 horizontal cuts | 4 wide, short pieces |
...
* ✅ "Count the grid units in each part"
...
* **Guide:** "You've been partitioning shapes and naming fractions. Let's review some of the important concepts."
...
**Problem EC.2a: Partition (CREATE)**

* **Visual:** Fresh undivided grid array (same fixed rectangle size as Lesson)  
* **Guide:** "Can you please partition this rectangle into three equal parts?"  
* **Prompt:** "Partition into 3 equal parts."  
* **Correct Answer:** 3 equal sections created (any valid orientation)  
* **Orientation Note:** Accept vertical OR horizontal cuts per Lesson 1.4 flexibility principle.  
* **On Correct:** "Nice. Three equal parts."

**Problem EC.2b: Shade (CREATE)**

* **Visual:** Student's partitioned rectangle from EC.2a  
* **Guide:** "Now shade one part to show one-third."  
* **Prompt:** "Shade 1 part."  
* **Correct Answer:** 1 of the 3 sections shaded.  
* **On Correct:** "Right. One-third. One out of three equal parts is shaded."  
...
* **Guide:** "Now let’s review hexagons. Which hexagon shows one-third?"  
* **Prompt:** "Select the hexagon that shows 1/3."  
* **Correct Answer:** Hexagon B  
* **On Correct:** “Right. This hexagon has one out of three shaded: ⅓.
...
* **Guide:** "You've learned a lot about equal parts. Let's look at how these ideas connect to even bigger patterns in math."
...
* **Connection (Guide states after task):** "This is a big idea in math—when we split one whole into more parts, each part gets smaller.  But here's an important thing to remember: we could only compare these parts because both rectangles started the same size. If one rectangle were bigger than the other, we couldn't just look at the number of total parts to know which piece is bigger."
...
* **Visual:** Four partitioned and shaded shapes:  
  ...
  * Hexagon: 1/3  
  * Grid array: 1/6  
* **Guide:** "Look at these partitioned shapes. They represent fractions. What is ONE rule that is always true about fractions?”   
* **Prompt:** "What is always true about fractions?"  
* **Options:**  
...
* **Guide:** "Great work\! Today you learned how to make equal parts, name them, and find them in the real world. Next time, we'll start naming fractions and see how they fit together."
