...
# Generated: 2026-02-06T11:24:15.588930
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "This number line shows fifths extending past 1. Place seven-fifths on the line.",
      "prompt": "Place seven-fifths on the number line.",
      "interaction_tool": "drag_label",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        ...
        "context": "Seven-fifths is at the seventh tick mark from 0, two intervals past 1"
      },
      "success_path_dialogue": "Right, 7/5 is two intervals past 1.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. Count seven fifths from zero - that takes us past 1."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this step by step. Seven-fifths means we need to count 7 intervals from 0. Remember, 5 fifths gets us to 1, so 7 fifths will be 2 intervals past 1."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. Seven-fifths means we count 7 of the fifth intervals starting from 0. First, we count to 1 - that's 5 fifths. Then we need 2 more fifths to get to 7 total. So we count: 1, 2, 3, 4, 5 to reach 1, then 6, 7 - two more intervals past 1. That's where 7/5 goes. That's how we place fractions greater than 1 on a number line."
          }
        ]
      }
    }
