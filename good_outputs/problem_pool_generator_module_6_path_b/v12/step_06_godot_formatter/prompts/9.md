...
# Generated: 2026-02-06T11:21:13.467760
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "Here's a number line divided into fourths. Drag the fraction label to show where six-fourths belongs.",
      "prompt": "Drag 6/4 to the correct position.",
      "interaction_tool": "drag_label",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        ...
        "context": "6/4 is at the sixth tick mark from zero, two intervals past 1"
      },
      "success_path_dialogue": "That's right. Six-fourths is six intervals from zero, two past one.",
      "error_path_generic": {
        "steps": [
          {
          ...
          },
          {
            ...
            "dialogue": "Let's think about this step by step. Six-fourths means we need to count six intervals of one-fourth each, starting from zero. Each fourth stays the same size even when we go past 1."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. Six-fourths means we count six intervals from zero. Starting at zero, we count: one-fourth, two-fourths, three-fourths, four-fourths - that gets us to 1. Then we keep counting: five-fourths, six-fourths. So six-fourths lands right here, two intervals past 1. That's how we count fractions past one on a number line."
          }
        ]
      }
    }
