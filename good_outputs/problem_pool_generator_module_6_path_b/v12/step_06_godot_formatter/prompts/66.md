...
# Generated: 2026-02-06T11:30:28.766236
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "Here's a number line showing thirds beyond one whole. Can you find where eight-thirds belongs?",
      "prompt": "Place a point at 8/3.",
      ...
      "correct_answer": {
        "value": "8/3",
        "context": "8/3 is the eighth tick mark from zero, which is two intervals past 2"
      },
      "success_path_dialogue": "That's right. Eight-thirds is two intervals beyond two.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. Count eight intervals from zero to find eight-thirds."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this together. Eight-thirds means we count 8 intervals from zero. Each interval is one-third. Start at zero and count each tick mark - one-third, two-thirds, three-thirds which is 1, then keep counting past 1 until you reach the eighth interval."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through finding eight-thirds. We need to count 8 intervals from zero. Let's count together: starting at zero, the first tick is one-third, the second is two-thirds, the third is three-thirds which equals 1. Now we keep going past 1 - the fourth tick is four-thirds, the fifth is five-thirds, the sixth is six-thirds which equals 2. Keep counting - the seventh tick is seven-thirds, and the eighth tick is eight-thirds. Eight-thirds is right here, two intervals past 2. That's how we locate fractions greater than one - we just keep counting intervals from zero."
          }
        ]
      }
    }
...

{
  ...
  "metadata": {
    ...
    "problem_id": 66,
    "template_id": "6008",
    "template_skill": "Student drags a single thirds fraction label or places a point beyond 1 on a pre-partitioned number line",
    "identifiers": ["8/3"],
    "mastery_tier": "BASELINE",
    "mastery_verb": "create",
    "telemetry_data": {
