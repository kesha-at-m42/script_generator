...
# Generated: 2026-02-06T11:22:29.665729
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "This number line is divided into fifths. Where should 6/5 go?",
      "prompt": "Place 6/5 on the number line.",
      "interaction_tool": "drag_label",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        ...
        "context": "6/5 is one fifth past 1, at the first tick mark after 1"
      },
      "success_path_dialogue": "Good, you found six-fifths. One interval past 1.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. Count six fifths from zero."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this together. Six-fifths means 6 parts, where each part is one-fifth. Start at zero and count 6 intervals to the right. Remember, each fifth is the same size, even past 1."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. Six-fifths means we need to count 6 of the fifth-sized intervals from zero. Starting at 0, we count: one-fifth, two-fifths, three-fifths, four-fifths, five-fifths - that's 1 whole. Then one more fifth gets us to six-fifths. That lands at the first tick mark past 1. That's how we locate fractions greater than 1 on the number line."
          }
        ]
      }
    }
