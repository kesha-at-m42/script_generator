...
# Generated: 2026-02-06T11:26:30.980153
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "This number line continues past 1. Let's place these fractions in order.",
      "prompt": "Place the fractions in order: 4/4, 5/4, 6/4.",
      "interaction_tool": "drag_label",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        ...
        "context": "Each fraction is placed at its corresponding tick mark, continuing the sequence past 1"
      },
        ...
        "steps": [
          {
            ...
            "dialogue": "Not quite. Count the fourths from 0 and keep going past 1."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this together. The number line shows fourths continuing past 1. Four fourths equals 1, then we keep counting—five fourths, six fourths. Each fraction label matches the tick mark at that position in the count."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. We're counting by fourths on this number line. Starting from 0, we count: one fourth, two fourths, three fourths, then four fourths—that's where we reach 1. But the number line continues, so we keep counting: five fourths, six fourths. So 4/4 goes at the fourth tick mark where 1 is, 5/4 goes at the fifth tick mark just past 1, and 6/4 goes at the sixth tick mark. That's how fractions work on a number line—the count continues past 1."
          }
        ]
      }
    }
