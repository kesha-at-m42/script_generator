...
# Generated: 2026-02-06T11:28:25.176519
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "Here's a number line with a point placed beyond 1. What fraction does the point represent?",
      "prompt": "The point is beyond 1. What fraction is it?",
      "interaction_tool": "click_choice",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        "value": "a",
        "context": "The point is at 9/8, which is one interval past 1 on a number line divided into eighths"
      },
      "success_path_dialogue": "Correct. That's nine-eighths, one interval beyond 1.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. First count the equal intervals from 0 to 1, then count from 0 to the point."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this step by step. First, count how many equal intervals there are from 0 to 1 - that's your denominator. I count 8 equal intervals, so we're working with eighths. Now count how many intervals from 0 to the point - that's your numerator. The point is beyond 1, so you'll need to count past 1."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through finding this fraction. First, we find the denominator by counting how many equal intervals are from 0 to 1. I count 8 equal intervals from 0 to 1, so the denominator is 8. This means we're working with eighths. Now for the numerator - we count how many of those intervals from 0 to where the point is. Starting at 0, I count 8 intervals to reach 1, then one more interval beyond 1 to reach the point. That's 9 intervals total from 0, so the numerator is 9. The answer is 9/8. Remember - always find the denominator first by counting equal intervals from 0 to 1, then the numerator by counting intervals from 0 to the point, even when the point is beyond 1."
          }
        ]
      }
    }
...

{
  ...
  "metadata": {
    ...
    "problem_id": 53,
    "template_id": "6006",
    "template_skill": "Student identifies the fraction shown by a point already placed past 1 on a pre-partitioned number line",
    "identifiers": ["9/8"],
    "mastery_tier": "STRETCH",
    "mastery_verb": "identify",
    "telemetry_data": {
      "mastery_skill": "Student can identify a fraction from a point placed beyond 1",
      "cognitive_verb": "identify",
      "mastery_skill_id": "M6-05",
      "tier": "STRETCH",
