...
# Generated: 2026-02-06T11:21:04.354071
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "This number line is divided into fourths. Let's place eight-fourths on it.",
      "prompt": "Place a point at eight-fourths.",
      ...
      "correct_answer": {
        "value": "2",
        "context": "8/4 equals 2 whole, which is eight fourth-intervals from zero"
      },
      "success_path_dialogue": "Right. Eight-fourths is the same as two wholes.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. Count eight fourths from zero."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this step by step. Eight-fourths means we need to count eight fourth-intervals starting from zero. Remember that we keep counting past 1 since we need eight fourths total."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. Eight-fourths means we count eight fourth-intervals from zero. Let's count them: one-fourth, two-fourths, three-fourths, four-fourths - that gets us to 1 whole. Then we keep going: five-fourths, six-fourths, seven-fourths, eight-fourths. That lands us right here at 2. Eight-fourths equals 2 wholes. That's how we count past 1 on a number line."
          }
        ]
      }
    }
