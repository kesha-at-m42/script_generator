...
# Generated: 2026-02-06T11:32:08.983669
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "Here's a number line divided into fifths that goes past 1. Drag the fraction label to where it belongs.",
      ...
      "correct_answer": {
        ...
        "context": "8/5 is eight intervals of one-fifth each from zero, or three intervals past 1"
      },
      "success_path_dialogue": "Right, eight-fifths is three intervals past 1.",
      "error_path_generic": {
        "steps": [
          {
            "scaffolding_level": "light",
            "dialogue": "Not quite. Count eight fifths from zero."
          },
          {
            "scaffolding_level": "medium",
            "dialogue": "Let's think about this more carefully. The denominator 5 tells us we're counting fifths. The numerator 8 tells us we need 8 of those fifths from zero. Remember that five-fifths equals 1, so eight-fifths goes past 1."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through placing eight-fifths. The number line is divided into fifths - that means each interval represents one-fifth. To find eight-fifths, we count 8 of these intervals from 0. Five intervals gets us to 1, then we count 3 more intervals past 1. That lands us at the tick mark labeled 8/5. That's how we locate fractions greater than 1 on the number line - we count past 1 just like we counted to get to 1."
          }
        ]
      }
    }
...

{
  ...
  "metadata": {
    ...
    "problem_id": 75,
    "template_id": "6010",
    "template_skill": "Student places halves or fifths fractions beyond 1 on a pre-partitioned number line",
    "identifiers": ["8/5"],
    "mastery_tier": "STRETCH",
    "mastery_verb": "create",
    "telemetry_data": {
      "mastery_skill": "Student can place fractions greater than 1 with transfer denominators (halves and fifths)",
      "cognitive_verb": "create",
