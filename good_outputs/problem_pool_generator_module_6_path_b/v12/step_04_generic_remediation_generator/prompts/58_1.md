...
# Generated: 2026-02-06T11:10:47.052717
======================================================================
...

{
  ...
  "prompt": "Which fraction is an improper fraction?",
  "interaction_tool": "click_choice",
  "workspace": [{"type": "choices", "options": [{"id": "a", "text": "3/4"}, {"id": "b", "text": "4/3"}]}],
  "correct_answer": {"value": "b", "context": "4/3 is an improper fraction because the numerator (4) is greater than the denominator (3), making it larger than 1"},
  "success_path_dialogue": "Right. The top number is bigger than the bottom number. That's an improper fraction.",
  "error_path_generic": {
      "steps": [
        {
