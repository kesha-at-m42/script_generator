...
# Generated: 2026-02-06T11:11:05.706652
======================================================================
...

{
  ...
  "prompt": "Where does 7/3 go? Place it on the line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 2], "ticks": ["0", "1/3", "2/3", "1", "4/3", "5/3", "2"], "labels": ["0", "1", "2"]}],
  "correct_answer": {"value": "7/3", "context": "7/3 is the seventh tick mark from zero, one tick past 2"},
  "success_path_dialogue": "Correct. You placed seven-thirds at the seventh third from zero.",
  "error_path_generic": {
      "steps": [
        {
