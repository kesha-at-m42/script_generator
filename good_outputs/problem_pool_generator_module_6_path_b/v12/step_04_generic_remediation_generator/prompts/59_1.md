...
# Generated: 2026-02-06T11:10:53.356044
======================================================================
...

{
  ...
  "prompt": "Place four-thirds on the number line.",
  "interaction_tool": "drag_label",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 2], "ticks": [{"value": "0", "is_read_only": true}, {"value": "1/3"}, {"value": "2/3"}, {"value": "1", "is_read_only": true}, {"value": "4/3"}, {"value": "5/3"}, {"value": "2", "is_read_only": true}], "labels": ["0", "1", "2"]}, {"type": "palette", "labels": ["4/3"]}],
  "correct_answer": {"value": "4/3", "context": "Four-thirds is one tick mark past 1, the fourth tick from zero"},
  "success_path_dialogue": "Correct. That's four-thirds, one interval past the whole.",
  "error_path_generic": {
      "steps": [
        {
