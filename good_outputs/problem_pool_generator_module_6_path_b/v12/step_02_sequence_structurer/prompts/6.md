...
# Generated: 2026-02-05T18:39:48.427506
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can extend partitioning past 1 maintaining equal spacing
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Good. You partitioned the line into thirds.", "Right, the pattern continues.", "Correct. Equal intervals all the way to 2.", "You extended the partition correctly."]
...
<input>
{
  ...
  "no_of_steps": 1,
  "workspace_description": "Number line from 0 to 2. Section 0-1 is pre-partitioned with tick marks at 0, 1/6, 2/6, 3/6, 4/6, 5/6, 1. Section 1-2 has only endpoints (1 and 2) marked.",
  "action_description": "Place tick",
  "prompt": "The line from 0 to 1 shows sixths. Place tick marks to continue the pattern from 1 to 2.",
  "mastery_tier": "BASELINE",
  "variables_used": {
    "denominators": [
      6
