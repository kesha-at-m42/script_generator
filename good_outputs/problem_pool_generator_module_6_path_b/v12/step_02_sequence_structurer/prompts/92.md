...
# Generated: 2026-02-05T18:48:54.762767
======================================================================
...
<input>
{
  "problem_instance_id": 92,
  "template_id": "6012",
  "problem_type": "Two-step: Student extends partition from 1-2 matching 0-1 spacing, then labels the beyond-1 positions",
  "no_of_steps": 2,
  "workspace_description": "Step 1: Number line from 0 to 2, with 0-1 pre-partitioned into sixths (ticks at 0, 1/6, 2/6, 3/6, 4/6, 5/6, 1), endpoints labeled. Section 1-2 blank for student partitioning. Step 2: After partition validated, drag palette with labels 7/6, 8/6 appears.",
