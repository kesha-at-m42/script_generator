...
# Generated: 2026-02-05T18:47:42.213077
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can extend partitioning past 1, then label fractions beyond 1
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Good, you partitioned the line into thirds.", "Correct, you placed 4/3 on the number line"]
...
<input>
{
  "problem_instance_id": 85,
  "template_id": "6012",
  "problem_type": "Two-step: Student extends partition from 1-2 matching 0-1 spacing, then labels the beyond-1 positions",
  "no_of_steps": 2,
  "workspace_description": "Step 1: Number line from 0 to 2, with 0-1 pre-partitioned into eighths (ticks at 0, 1/8, 2/8, 3/8, 4/8, 5/8, 6/8, 7/8, 1), endpoints labeled. Section 1-2 blank for student partitioning. Step 2: After partition validated, drag palette with labels 9/8, 10/8 appears.",
  "action_description": "Student first places tick marks to extend the partition from 1 to 2 (step 1), then drags fraction labels to the beyond-1 positions (step 2).",
  "prompt": "First make equal spaces from 1 to 2, then label the fractions beyond 1.",
