...
# Generated: 2026-02-05T18:44:36.365127
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can recognize improper fractions and explain why they exceed 1
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Right. The top number is bigger than the bottom number. That's an improper fraction.", "Yes, 5/4 is an improper fraction. The numerator is greater than the denominator.", "Correct. 4/3 is greater than 1, 4/3 is an improper fraction."]
...
<input>
{
  ...
  "no_of_steps": 1,
  "workspace_description": "Display showing the fraction 5/4 prominently. Three explanation options presented below the fraction.",
  "action_description": "MCQ - Student selects one explanation from the options provided.",
  "prompt": "5/4 is called an improper fraction. Why is it past 1?",
