...
# Generated: 2026-02-05T18:40:15.620866
======================================================================
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Five-fourths. Five spaces from zero, it’s past one.", "Right, six intervals from zero.", "7/4. Seven fourth intervals from 0. Three past 1."]
...
<input>
{
  "problem_instance_id": 11,
  "template_id": "6002",
  "problem_type": "Student drags a single fraction label or places a point at the correct position beyond 1 on a pre-partitioned number line (fourths only)",
  "no_of_steps": 1,
  "workspace_description": "Number line from 0 to 2, pre-partitioned into fourths with tick marks at 0, 1/4, 2/4, 3/4, 1, 5/4, 6/4, 7/4, 2. Labels at 0, 1, and 2 only. Drag palette with fraction label '7/4'.",
  "action_description": "Label tick marks by dragging fraction label",
  "prompt": "Where does 7/4 go? Place it on the line.",
  "mastery_tier": "BASELINE",
  "variables_used": {
    "fractions": [
      "7/4"
