...
# Generated: 2026-02-01T22:58:13.846066
======================================================================
...

{
  ...
  "prompt": "Select the number line that shows fifths.",
  "interaction_tool": "select",
  "workspace": [{"id": "line_unequal", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/6", "1/4", "1/3", "1/2", "3/4", "1"], "labels": ["0", "1"], "description": "Six unequal intervals"}, {"id": "line_fourths", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/4", "1/2", "3/4", "1"], "labels": ["0", "1"], "description": "Four equal intervals (fourths)"}, {"id": "line_fifths", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/5", "2/5", "3/5", "4/5", "1"], "labels": ["0", "1"], "description": "Five equal intervals (fifths)"}],
  "correct_answer": {"value": "line_fifths", "context": "Fifths require five equal intervals between 0 and 1"},
  "success_path_dialogue": "Yes, this line has five equal intervals.",
  "error_path_generic":
