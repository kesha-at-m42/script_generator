...
# Generated: 2026-02-01T22:58:07.574229
======================================================================
...

{
  ...
  "prompt": "Select the number line partitioned into fourths.",
  "interaction_tool": "select",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/3", "2/3", "1"], "labels": ["0", "1"], "description": "3 equal intervals (thirds)"}, {"id": "line_2", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/4", "1/2", "3/4", "1"], "labels": ["0", "1"], "description": "4 equal intervals (fourths)"}, {"id": "line_3", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/6", "1/3", "2/3", "1"], "labels": ["0", "1"], "description": "4 unequal intervals"}],
  "correct_answer": {"value": "line_2", "context": "This number line has 4 equal intervals, making fourths"},
  "success_path_dialogue": "That's right. This line has four equal intervals.",
  "error_path_generic":
