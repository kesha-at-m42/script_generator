...
# Generated: 2026-02-05T15:16:40.886100
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can label fractions beyond 1 on extended number lines
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Yes! Four thirds means four intervals from 0.", "Right. We keep counting: 4/3, 5/3...", "Good. 5/4 is five spaces from zero.", "Correct, the pattern of thirds continues beyond 1."]
...
<input>
{
  "problem_instance_id": 62,
  "template_id": "5008",
  "problem_type": "Student drags fraction labels to tick positions beyond 1 on a 0-2 number line",
  "no_of_steps": 1,
  "workspace_description": "Number line from 0 to 2, pre-partitioned into eighths with tick marks at 0, 1/8, 2/8, 3/8, 4/8, 5/8, 6/8, 7/8, 1, 9/8, 10/8, 11/8, 12/8, 13/8, 14/8, 15/8, 2. Labels pre-placed for 0 through 1. Drag palette contains 9/8, 10/8, 11/8.",
  "action_description": "Label tick marks by dragging fraction labels to them",
