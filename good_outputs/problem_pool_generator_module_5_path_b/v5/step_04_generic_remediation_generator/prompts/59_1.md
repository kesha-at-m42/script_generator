...
# Generated: 2026-02-05T15:17:01.919335
======================================================================
...

{
  ...
  "prompt": "What comes after 3/3? Label it.",
  "interaction_tool": "drag_label",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 2], "ticks": ["0", "1/3", "2/3", "1", "4/3", "5/3", "2"], "labels": ["0", "1/3", "2/3", "3/3"]}, {"type": "palette", "labels": ["4/3"]}],
  "correct_answer": {"value": {"4/3": "4/3"}, "context": "Four-thirds is the next tick mark after 3/3 in the pattern of thirds"},
  "success_path_dialogue": "Yes! Four thirds means four intervals from 0.",
  "error_path_generic": {
      "steps": [
        {
