...
# Generated: 2026-02-05T15:16:54.759854
======================================================================
...

{
  ...
  "prompt": "Place the label for 5/4.",
  "interaction_tool": "drag_label",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 2], "ticks": [{"position": "0", "is_read_only": true}, {"position": "1/4", "is_read_only": true}, {"position": "2/4", "is_read_only": true}, {"position": "3/4", "is_read_only": true}, {"position": "1", "is_read_only": true}, {"position": "5/4"}, {"position": "6/4", "is_read_only": true}, {"position": "7/4", "is_read_only": true}, {"position": "2", "is_read_only": true}], "labels": ["0", "1/4", "2/4", "3/4", "1"]}, {"type": "palette", "labels": ["5/4"]}],
  "correct_answer": {"value": {"tick": "5/4", "label": "5/4"}, "context": "5/4 is one tick mark past 1, continuing the pattern of fourths"},
  "success_path_dialogue": "Yes! Five-fourths is one space past 1.",
  "error_path_generic": {
      "steps": [
        {
