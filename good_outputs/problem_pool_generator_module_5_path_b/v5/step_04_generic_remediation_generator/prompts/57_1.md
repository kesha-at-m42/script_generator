...
# Generated: 2026-02-05T15:16:48.731700
======================================================================
...

{
  ...
  "prompt": "Label the tick mark that shows 4/3.",
  "interaction_tool": "drag_label",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 2], "ticks": [{"value": "0", "is_read_only": true}, {"value": "1/3", "is_read_only": true}, {"value": "2/3", "is_read_only": true}, {"value": "1", "is_read_only": true}, {"value": "4/3"}, {"value": "5/3", "is_read_only": false}, {"value": "2", "is_read_only": true}], "labels": ["0", "1/3", "2/3", "1"]}, {"type": "palette", "labels": ["4/3"]}],
  "correct_answer": {"value": {"line_id": "line_1", "tick": "4/3", "label": "4/3"}, "context": "4/3 is one third past 1, the fourth tick mark from 0"},
  "success_path_dialogue": "Yes! Four thirds means four intervals from 0.",
  "error_path_generic": {
      "steps": [
        {
