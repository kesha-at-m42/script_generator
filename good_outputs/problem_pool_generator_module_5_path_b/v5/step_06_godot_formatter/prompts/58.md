...
# Generated: 2026-02-05T15:17:40.654645
======================================================================
...
<input>
{
  ...
  "steps": [
    {
      "step_id": 1,
      "dialogue": "The line goes past 1. Let's place five-fourths.",
      "prompt": "Place the label for 5/4.",
      "interaction_tool": "drag_label",
      "workspace": [
        {
          "id": "line_1",
      ...
      "correct_answer": {
        ...
        "context": "5/4 is one tick mark past 1, continuing the pattern of fourths"
      },
      "success_path_dialogue": "Yes! Five-fourths is one space past 1.",
      "error_path_generic": {
        "steps": [
          {
          ...
          },
          {
            ...
            "dialogue": "Let's think about this a bit more. Five-fourths means 5 of the fourth-sized parts. Start at zero and count 5 of those equal intervals to find where the label goes."
          },
          {
            "scaffolding_level": "heavy",
            "dialogue": "Let me walk you through this. Five-fourths means we need to count 5 fourths starting from zero. The number line shows fourths - each interval is one-fourth. From zero, we count: one-fourth, two-fourths, three-fourths, four-fourths - that gets us to 1. Then we need one more fourth to get to five-fourths. So five-fourths goes one tick mark past 1, right here. That's how we count past 1 on a number line - the fourths just keep going."
          }
        ]
      }
    }
