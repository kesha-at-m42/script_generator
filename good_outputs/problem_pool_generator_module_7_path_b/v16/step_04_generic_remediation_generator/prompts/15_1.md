...
# Generated: 2026-02-11T16:43:28.439183
======================================================================
...
<input>
{
  ...
  "no_of_steps": 1,
  "step_id": 1,
  "dialogue": "Look at the point at 1 on this number line. It shows 6/6. Why does 6/6 equal 1 whole?",
  ...
  "workspace": [
    ...
    },
    {
      ...
      "options": [
        {
          "id": "a",
          "text": "6 parts out of 6 total—that's all of them, which is 1 whole"
        },
        {
          "id": "b",
          "text": "Because 6 minus 6 equals 0"
        },
        {
          "id": "c",
          "text": "Because six sixths is more than five sixths"
        },
        {
          "id": "d",
          "text": "Because it's past zero on the number line"
        }
      ]
    }
  ],
  "correct_answer": {
    "value": "a",
    "context": "When all parts are present (6 out of 6), they make one complete whole"
  },
  "success_path_dialogue": "Exactly. When you have all the parts, you have one whole."
}
</input>
...

{
  ...
  "prompt": "Select the best explanation for why 6/6 = 1.",
  "interaction_tool": "click_choice",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/6", "2/6", "3/6", "4/6", "5/6", "1"], "points": ["1"], "labels": ["0", "1"]}, {"type": "choices", "options": [{"id": "a", "text": "6 parts out of 6 total—that's all of them, which is 1 whole"}, {"id": "b", "text": "Because 6 minus 6 equals 0"}, {"id": "c", "text": "Because six sixths is more than five sixths"}, {"id": "d", "text": "Because it's past zero on the number line"}]}],
  "correct_answer": {"value": "a", "context": "When all parts are present (6 out of 6), they make one complete whole"},
  "success_path_dialogue": "Exactly. When you have all the parts, you have one whole.",
  "error_path_generic": {
      "steps": [
        {
