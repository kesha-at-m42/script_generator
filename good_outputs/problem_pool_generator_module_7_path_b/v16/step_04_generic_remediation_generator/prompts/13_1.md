...
# Generated: 2026-02-11T16:43:15.547488
======================================================================
...
<input>
{
  ...
  "no_of_steps": 1,
  "step_id": 1,
  "dialogue": "Look at the point on this number line. It's at the last tick mark, showing four-fourths.",
  "prompt": "Which statement explains why 4/4 is the same as one whole?",
  "interaction_tool": "click_choice",
  "workspace": [
    {
      "id": "line_1",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "id": "b",
          "text": "Because 4 is an even number"
        },
        {
          "id": "c",
          "text": "Because the numbers match"
        },
        {
          "id": "d",
          "text": "Because it comes after 3/4"
        }
      ]
    }
  ],
  "correct_answer": {
    "value": "a",
    "context": "When all parts are present (4 out of 4), they combine to make one complete whole"
  },
  "success_path_dialogue": "Right. All 4 parts out of 4 makes one whole."
}
</input>
...

{
  ...
  "prompt": "Which statement explains why 4/4 is the same as one whole?",
  "interaction_tool": "click_choice",
  "workspace": [{"id": "line_1", "type": "number_line", "range": [0, 1], "ticks": ["0", "1/4", "2/4", "3/4", "4/4"], "points": ["4/4"], "labels": ["0", "4/4"]}, {"type": "choices", "options": [{"id": "a", "text": "We have all the parts, so it makes a complete whole"}, {"id": "b", "text": "Because 4 is an even number"}, {"id": "c", "text": "Because the numbers match"}, {"id": "d", "text": "Because it comes after 3/4"}]}],
  "correct_answer": {"value": "a", "context": "When all parts are present (4 out of 4), they combine to make one complete whole"},
  "success_path_dialogue": "Right. All 4 parts out of 4 makes one whole.",
  "error_path_generic": {
      "steps": [
        {
