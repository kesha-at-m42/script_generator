...
# Generated: 2026-02-13T22:27:05.352572
======================================================================
...
<input>
{
  ...
  "workspace_description": "Step 1: 1 reference FracShape bar at top with 3 option bars below (4 bars total). Step 2: Two NumLines stacked (both 0-1) appear after correct Step 1 answer. Top line shows reference fraction pre-placed, bottom line for student placement. Validation gate between steps.",
  "prompt_examples": [
  ...
  "step_sequence": {
    "step_1": {
      "action": "select_tangible",
      "target": "equivalent bar from 3 options",
      "validates_before_step_2": true
    },
    "step_2": {
      "action": "place_point",
      "target": "equivalent fraction on number line"
    }
  },
  "parameter_coverage": {
    "reference_fractions": [
