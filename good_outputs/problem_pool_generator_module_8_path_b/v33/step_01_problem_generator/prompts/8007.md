...
# Generated: 2026-02-13T22:25:32.883491
======================================================================
...
<input>
{
  ...
  "workspace_description": "Two NumLines stacked vertically, both 0 to 1. Top line shows reference fraction pre-placed (e.g., 1/2 with a labelled point). Bottom line has same tick marks but no point — student places equivalent fraction. Visual comparison shows both land at same position.",
  "prompt_examples": [
