...
# Generated: 2026-02-13T22:36:42.729629
======================================================================
...

{
  ...
  "prompt": "Shade this bar to show a fraction equal to one half.",
  "interaction_tool": "shade",
  "workspace": [{"id": "bar_reference", "type": "fraction_strip", "role": "reference", "description": "Reference bar showing 1/2 (one of two equal parts shaded)", "range": [0, 1], "intervals": "1/2", "intervals_is_shaded": [0]}, {"id": "bar_target", "type": "fraction_strip", "role": "student_interaction", "description": "Empty fraction strip divided into 4 equal parts", "range": [0, 1], "intervals": "1/4", "intervals_is_shaded": false}],
  "correct_answer": {"value": [0, 1], "context": "Shading 2 out of 4 parts creates 2/4, which equals 1/2"},
  "success_path_dialogue": "Good. You shaded two out of four equal parts.",
  "error_path_generic": {
      "steps": [
        {
