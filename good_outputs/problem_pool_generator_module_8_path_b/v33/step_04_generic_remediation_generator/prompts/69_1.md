...
# Generated: 2026-02-13T22:39:10.652947
======================================================================
...

{
  ...
  "prompt": "Select the bar that matches 3/6.",
  "interaction_tool": "select",
  "workspace": [{"id": "reference_bar", "type": "fraction_strip", "role": "reference", "description": "Reference bar showing 3/6 shaded", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": [0, 1, 2]}, {"id": "bar_a", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 1/2 shaded", "range": [0, 1], "intervals": "1/2", "intervals_is_shaded": [0]}, {"id": "bar_b", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 3/8 shaded", "range": [0, 1], "intervals": "1/8", "intervals_is_shaded": [0, 1, 2]}, {"id": "bar_c", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 2/4 shaded", "range": [0, 1], "intervals": "1/4", "intervals_is_shaded": [0, 1]}],
  "correct_answer": {"value": "bar_a", "context": "Bar A shows 1/2 shaded, which is equivalent to 3/6"},
  "success_path_dialogue": "Good. Now let's verify on the number line.",
  "error_path_generic": {
      "steps": [
        {
