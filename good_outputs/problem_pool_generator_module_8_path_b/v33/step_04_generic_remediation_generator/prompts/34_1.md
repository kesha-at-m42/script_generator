...
# Generated: 2026-02-13T22:35:24.112837
======================================================================
...

{
  ...
  "prompt": "Place three sixths on the bottom line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_top", "type": "number_line", "role": "reference", "description": "Reference number line from 0 to 1 with point and label at 1/2", "range": [0, 1], "ticks": ["0", "1/2", "1"], "points": ["1/2"], "labels": ["0", "1/2", "1"]}, {"id": "line_bottom", "type": "number_line", "role": "student_interaction", "description": "Number line from 0 to 1 with tick marks at sixths, endpoints labeled", "range": [0, 1], "ticks": ["0", "1/6", "2/6", "3/6", "4/6", "5/6", "1"], "labels": ["0", "1"]}],
  "correct_answer": {"value": "3/6", "context": "Three sixths lands at the same position as one half on the top line, showing they are equivalent fractions"},
  "success_path_dialogue": "Right there. Three sixths lands at the same point as one half.",
  "error_path_generic": {
      "steps": [
        {
