...
# Generated: 2026-02-13T22:38:17.842423
======================================================================
...

{
  ...
  "prompt": "Select the bar that shows a fraction equivalent to one third.",
  "interaction_tool": "select",
  "workspace": [{"id": "ref_bar", "type": "fraction_strip", "role": "reference", "description": "Reference bar showing 1/3 shaded", "range": [0, 1], "intervals": "1/3", "intervals_is_shaded": [0]}, {"id": "bar_a", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 2/6 shaded", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": [0, 1]}, {"id": "bar_b", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 3/6 shaded", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": [0, 1, 2]}, {"id": "bar_c", "type": "fraction_strip", "role": "student_interaction", "description": "Bar showing 1/6 shaded", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": [0]}],
  "correct_answer": {"value": "bar_a", "context": "Bar A shows 2/6, which is equivalent to 1/3"},
  "success_path_dialogue": "Correct. Two sixths equals one third.",
  "error_path_generic": {
      "steps": [
        {
