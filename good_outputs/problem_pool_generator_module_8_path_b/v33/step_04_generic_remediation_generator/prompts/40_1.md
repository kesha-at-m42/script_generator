...
# Generated: 2026-02-13T22:36:07.423387
======================================================================
...

{
  ...
  "prompt": "Place 4/6 on the bottom number line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_reference", "type": "number_line", "role": "reference", "description": "Reference number line with point at 2/3", "range": [0, 1], "ticks": ["0", "1/3", "2/3", "1"], "points": ["2/3"], "labels": ["0", "2/3", "1"]}, {"id": "line_student", "type": "number_line", "role": "student_interaction", "description": "Number line divided into sixths for student interaction", "range": [0, 1], "ticks": ["0", "1/6", "2/6", "3/6", "4/6", "5/6", "1"], "labels": ["0", "1"]}],
  "correct_answer": {"value": "4/6", "context": "4/6 is equivalent to 2/3 and lands at the same position on the number line"},
  "success_path_dialogue": "Yes. Four sixths and two thirds are at the same position.",
  "error_path_generic": {
      "steps": [
        {
