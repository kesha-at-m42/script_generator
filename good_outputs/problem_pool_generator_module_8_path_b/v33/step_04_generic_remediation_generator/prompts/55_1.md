...
# Generated: 2026-02-13T22:37:50.412897
======================================================================
...

{
  ...
  "prompt": "How many sixths equal two thirds? Shade to show.",
  "interaction_tool": "shade",
  "workspace": [{"id": "bar_reference", "type": "fraction_strip", "role": "reference", "description": "Reference bar showing 2/3 shaded", "range": [0, 1], "intervals": "1/3", "intervals_is_shaded": [0, 1], "intervals_is_read_only": true}, {"id": "bar_target", "type": "fraction_strip", "role": "student_interaction", "description": "Empty bar partitioned into sixths", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": false}],
  "correct_answer": {"value": [0, 1, 2, 3], "context": "Four sixths equals two thirds - the student shades any 4 of the 6 sections to create an equivalent fraction"},
  "success_path_dialogue": "That's it. Four sixths equals two thirds.",
  "error_path_generic": {
      "steps": [
        {
