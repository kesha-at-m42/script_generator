...
# Generated: 2026-02-13T22:35:16.873316
======================================================================
...

{
  ...
  "prompt": "Place two fourths on the line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_reference", "type": "number_line", "role": "reference", "description": "Number line showing 1/2 with point and label", "range": [0, 1], "ticks": ["0", "1/2", "1"], "points": ["1/2"], "labels": ["0", "1/2", "1"]}, {"id": "line_student", "type": "number_line", "role": "student_interaction", "description": "Number line with fourths, endpoints labeled only", "range": [0, 1], "ticks": ["0", "1/4", "2/4", "3/4", "1"], "labels": ["0", "1"]}],
  "correct_answer": {"value": "2/4", "context": "2/4 lands at the same position as 1/2 on the reference line, proving they are equivalent fractions"},
  "success_path_dialogue": "Right there. Two fourths lands at the same point as one half.",
  "error_path_generic": {
      "steps": [
        {
