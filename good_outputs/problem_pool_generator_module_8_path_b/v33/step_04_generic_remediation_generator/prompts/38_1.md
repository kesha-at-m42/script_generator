...
# Generated: 2026-02-13T22:35:52.064430
======================================================================
...

{
  ...
  "prompt": "Place four eighths on the number line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_top", "type": "number_line", "role": "reference", "description": "Reference number line showing 1/2 with point and label", "range": [0, 1], "ticks": ["0", "1/2", "1"], "points": ["1/2"], "labels": ["0", "1/2", "1"]}, {"id": "line_bottom", "type": "number_line", "role": "student_interaction", "description": "Number line with eighths, endpoints labeled", "range": [0, 1], "ticks": ["0", "1/8", "2/8", "3/8", "4/8", "5/8", "6/8", "7/8", "1"], "labels": ["0", "1"]}],
  "correct_answer": {"value": "4/8", "context": "4/8 lands at the same position as 1/2, showing they are equivalent fractions"},
  "success_path_dialogue": "Right there. Four eighths lands at the same point as one half.",
  "error_path_generic": {
      "steps": [
        {
