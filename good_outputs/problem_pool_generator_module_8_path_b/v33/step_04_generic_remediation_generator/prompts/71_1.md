...
# Generated: 2026-02-13T22:39:39.980536
======================================================================
...

{
  ...
  "prompt": "Select the bar that shows an equivalent fraction to 2/4.",
  "interaction_tool": "select",
  "workspace": [{"id": "ref_bar", "type": "fraction_strip", "role": "reference", "description": "Reference bar showing 2/4 shaded", "range": [0, 1], "intervals": "1/4", "intervals_is_shaded": [0, 1]}, {"id": "bar_a", "type": "fraction_strip", "role": "student_interaction", "description": "Bar A showing 3/6 shaded", "range": [0, 1], "intervals": "1/6", "intervals_is_shaded": [0, 1, 2]}, {"id": "bar_b", "type": "fraction_strip", "role": "student_interaction", "description": "Bar B showing 4/8 shaded", "range": [0, 1], "intervals": "1/8", "intervals_is_shaded": [0, 1, 2, 3]}, {"id": "bar_c", "type": "fraction_strip", "role": "student_interaction", "description": "Bar C showing 2/8 shaded", "range": [0, 1], "intervals": "1/8", "intervals_is_shaded": [0, 1]}],
  "correct_answer": {"value": "bar_a", "context": "Bar A shows 3/6, which is equivalent to 2/4 (both represent one-half)"},
  "success_path_dialogue": "Good. Bar A shows three-sixths—the same amount as two-fourths.",
  "error_path_generic": {
      "steps": [
        {
