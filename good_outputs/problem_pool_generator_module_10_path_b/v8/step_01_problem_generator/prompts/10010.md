...
# Generated: 2026-02-20T16:46:10.009352
======================================================================
...
<input>
{
  "template_id": "10010",
  "skill_id": "M10-06",
  "skill": "Student can place fractions on number lines and identify which is greater based on position",
  ...
  "workspace_description": "Three sequential workspaces. Step 1: Two number lines visible, both 0-1 range, same denominator tick marks, labeled 0 and 1. Top line is active (student places point). Bottom line is read-only reference with no point yet. Step 2: Top line is now read-only showing placed point from Step 1. Bottom line becomes active (student places point). Step 3: Both lines read-only with points placed. MathExpression shows fraction pair with symbol placeholder. Three symbol choices: <, =, >.",
  "prompt_examples": [
    "Step 1: Place two-sevenths on the top line. Step 2: Now place four-sevenths on the bottom line. Step 3: Which symbol correctly compares these fractions?",
    "Step 1: Mark two-sixths on the top number line. Step 2: Mark five-sixths on the bottom line. Step 3: Select the correct symbol.",
    "Step 1: Place three-eighths on the top line. Step 2: Place five-eighths on the bottom line. Step 3: Which symbol makes this comparison true?"
  ],
  "action_description": "Step 1: Student clicks a tick mark on the top number line to place a point. Step 2: Student clicks a tick mark on the bottom number line to place a point. Step 3: Student clicks one symbol (<, =, >) from three choices.",
  "mastery_tier": [
    "baseline",
    "stretch"
  ],
  ...
  "correct_end_state": "Both points placed correctly and correct comparison symbol selected",
  "success_dialogue": [
    "That's right. The fraction farther to the right is greater.",
    "Correct. You placed both fractions and chose the right symbol.",
    "Yes. The position on the number line shows which is bigger.",
    "Right. Same denominator means you can compare by position."
  ],
  "no_of_steps": 3,
  "target_count": 6
}
