...
# Generated: 2026-02-17T19:07:28.107384
======================================================================
...
---
  ...
  ### Labels
  Text annotations showing fraction values on the strip.

  #### fraction_label
  A label showing the total fraction represented by all shaded intervals (e.g., "4/6" appears beside the bar).

  - **Type**: Boolean
  - **Description**: Use when the bar needs to identify itself — especially in comparison and symbol-selection problems where both fractions must be clearly named
  ...
  **Strip with fraction_label (comparison problems):**
  ```
  intervals: 1/6
  shaded_intervals: 4
  fraction_label: true
  // Creates: Sixths strip with 4 intervals shaded, "4/6" label beside it
  ```
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can order three fractions from smallest to largest with same denominator (harder denominators/closer values)
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["That's right. They're all in order now.", "Correct. That's the right sequence.", "Yes. That's the order from smallest to largest.", "Right. That's the correct order."]
...
<input>
{
  "problem_instance_id": 43,
  "template_id": "10008",
  "problem_type": "Student selects which sequence shows three fractions in correct order from smallest to largest",
  "no_of_steps": 1,
  "workspace_description": "Three rectangle bars displayed horizontally, all divided into tenths. First bar shows 1 interval shaded (1/10), second bar shows 4 intervals shaded (4/10), third bar shows 6 intervals shaded (6/10). Multiple choice shows three possible orderings.",
  "action_description": "Student selects option A: '1/10, 4/10, 6/10' (the correct ordering from smallest to largest)",
