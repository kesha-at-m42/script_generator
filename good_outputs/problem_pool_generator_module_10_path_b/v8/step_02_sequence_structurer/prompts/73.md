...
# Generated: 2026-02-20T16:49:55.398933
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can select explanation that correctly describes why one fraction is greater
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["That's right. That explanation is correct.", "Correct. That's the right reasoning.", "Yes. Same size pieces, but more of them.", "Right. That's the correct explanation."]
...
<input>
{
  ...
  "_generated_at": "2026-02-20T22:46:47.082499+00:00"
}
</input>
