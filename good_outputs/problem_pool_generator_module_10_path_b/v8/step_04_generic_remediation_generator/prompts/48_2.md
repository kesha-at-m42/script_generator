...
# Generated: 2026-02-20T16:50:13.205034
======================================================================
...

{
  ...
  "prompt": "Place five-sixths on the bottom line.",
  "interaction_tool": "place_point",
  "workspace": [{"id": "line_top", "type": "number_line", "role": "reference", "description": "Top number line 0-1 with sixths marks and point at 2/6, now read-only", "range": [0, 1], "ticks": ["0", "1/6", "2/6", "3/6", "4/6", "5/6", "1"], "points": ["2/6"], "labels": ["0", "1"]}, {"id": "line_bottom", "type": "number_line", "role": "student_interaction", "description": "Bottom number line 0-1 with sixths marks, active for placing point", "range": [0, 1], "ticks": ["0", "1/6", "2/6", "3/6", "4/6", "5/6", "1"], "labels": ["0", "1"]}],
  "correct_answer": {"value": {"line_id": "line_bottom", "position": "5/6"}, "context": "Point placed at 5/6 on the bottom number line"},
  "success_path_dialogue": "That's right. Five-sixths is placed on the bottom line.",
  "error_path_generic": {
      "steps": [
        {
