...
# Generated: 2026-02-17T19:07:46.973787
======================================================================
...

{
  ...
  "mastery_verb": "compare",
  "template_id": "10008",
  "fractions": ["3/10", "7/10", "9/10"],
  "dialogue": "Here are three bars showing different fractions. Arrange them from smallest to largest.",
  "prompt": "Select the correct order from least to greatest.",
  "interaction_tool": "click_choice",
  "workspace": [{"id": "bar_1", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into tenths with 3 intervals shaded", "range": [0, 1], "intervals": "1/10", "shaded_intervals": 3, "fraction_label": true}, {"id": "bar_2", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into tenths with 7 intervals shaded", "range": [0, 1], "intervals": "1/10", "shaded_intervals": 7, "fraction_label": true}, {"id": "bar_3", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into tenths with 9 intervals shaded", "range": [0, 1], "intervals": "1/10", "shaded_intervals": 9, "fraction_label": true}, {"type": "choices", "options": [{"id": "a", "text": "3/10, 7/10, 9/10"}, {"id": "b", "text": "9/10, 7/10, 3/10"}, {"id": "c", "text": "7/10, 3/10, 9/10"}]}],
  "correct_answer": {"value": "a", "context": "3/10 < 7/10 < 9/10 is the correct ascending order"},
  "success_path_dialogue": "That's right. They're all in order now.",
  "error_path_generic": {
      "steps": [
        {
