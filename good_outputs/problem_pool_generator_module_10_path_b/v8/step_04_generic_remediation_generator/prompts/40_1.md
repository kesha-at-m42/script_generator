...
# Generated: 2026-02-17T19:07:40.911113
======================================================================
...

{
  ...
  "mastery_verb": "compare",
  "template_id": "10008",
  "fractions": ["2/8", "5/8", "7/8"],
  "dialogue": "Here are three bars showing different fractions. Can you put them in order from smallest to largest?",
  "prompt": "Which option shows these fractions in order from smallest to largest?",
  "interaction_tool": "click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into eighths with 2 intervals shaded", "range": [0, 1], "intervals": "1/8", "shaded_intervals": 2, "fraction_label": true}, {"id": "bar_b", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into eighths with 5 intervals shaded", "range": [0, 1], "intervals": "1/8", "shaded_intervals": 5, "fraction_label": true}, {"id": "bar_c", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into eighths with 7 intervals shaded", "range": [0, 1], "intervals": "1/8", "shaded_intervals": 7, "fraction_label": true}, {"type": "choices", "options": [{"id": "a", "text": "2/8, 5/8, 7/8"}, {"id": "b", "text": "7/8, 5/8, 2/8"}, {"id": "c", "text": "5/8, 2/8, 7/8"}]}],
  "correct_answer": {"value": "a", "context": "2/8 has the least shading, then 5/8, then 7/8 has the most"},
  "success_path_dialogue": "That's right. They're all in order now.",
  "error_path_generic": {
      "steps": [
        {
