...
# Generated: 2026-02-19T19:07:36.659357
======================================================================
...
<input>
{
  "template_id": "12012",
  "skill_id": "M12-08",
  "skill": "Student can identify which of three comparison strategies applies to a given fraction pair",
  ...
  "workspace_description": "Two unlabelled fraction bars with a MathExpression comparing the fraction pair with the correct symbol. Student selects one strategy from the options.",
  "mcq_options": [
  ...
  "prompt_examples": [
    "Which strategy helps you compare this pair?",
    "Look at the two fractions. What do you notice? Which strategy applies?",
    "Which approach would you use to compare these fractions?"
  ],
  "action_description": "Student clicks one strategy from three options",
  "mastery_tier": [
    "baseline",
    "stretch"
  ],
  ...
  "correct_end_state": "Correct strategy label selected",
  "success_dialogue": [
    "Right. Check for the same denominator, then count the parts.",
    "Correct. Check for the same numerator, then compare piece sizes.",
    "Yes, if neither numerator or denominator are same, use benchmark."
  ],
  "no_of_steps": 1,
  "target_count": 5
}
