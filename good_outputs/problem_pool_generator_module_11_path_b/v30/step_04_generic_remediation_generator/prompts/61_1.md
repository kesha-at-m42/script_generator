...
# Generated: 2026-02-19T17:37:10.036490
======================================================================
...

{
  ...
  "prompt": "Which TWO steps of the strategy apply here?",
  "interaction_tool": "multi_click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "reference", "description": "Bar divided into thirds with 2 intervals shaded", "range": [0, 1], "intervals": "1/3", "shaded_intervals": 2}, {"id": "bar_b", "type": "fraction_strip", "role": "reference", "description": "Bar divided into sixths with 2 intervals shaded", "range": [0, 1], "intervals": "1/6", "shaded_intervals": 2}, {"id": "expression_1", "type": "math_expression", "role": "reference", "description": "Expression showing 2/3 > 2/6", "terms": ["2/3", ">", "2/6"]}, {"type": "choices", "options": [{"id": "a", "text": "Check for same numerator"}, {"id": "b", "text": "Compare the sizes of parts"}, {"id": "c", "text": "Check for same denominator"}, {"id": "d", "text": "Add the denominators"}], "allow_multiple": true}],
  "correct_answer": {"value": ["a", "b"], "context": "Both fractions have the same numerator (2), so you compare the sizes of the parts to determine which fraction is greater"},
  "success_path_dialogue": "Right. Same numerator means you compare piece sizes.",
  "error_path_generic": {
      "steps": [
        {
