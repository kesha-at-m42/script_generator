...
# Generated: 2026-02-19T17:36:02.910900
======================================================================
...

{
  ...
  "prompt": "Which fraction is greater?",
  "interaction_tool": "click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into sixths with 2 pieces shaded", "range": [0, 1], "intervals": "1/6", "shaded_intervals": 2}, {"id": "bar_b", "type": "fraction_strip", "role": "student_interaction", "description": "Bar divided into ninths with 2 pieces shaded", "range": [0, 1], "intervals": "1/9", "shaded_intervals": 2}, {"id": "expression_a", "type": "math_expression", "role": "student_interaction", "description": "Label for bar A showing 2/6", "terms": ["2/6"]}, {"id": "expression_b", "type": "math_expression", "role": "student_interaction", "description": "Label for bar B showing 2/9", "terms": ["2/9"]}, {"type": "choices", "options": [{"id": "a", "text": "2/6 > 2/9"}, {"id": "b", "text": "2/6 = 2/9"}, {"id": "c", "text": "2/6 < 2/9"}]}],
  "correct_answer": {"value": "a", "context": "2/6 > 2/9 because sixths are bigger pieces than ninths. Same count shaded, but bigger pieces means greater fraction."},
  "success_path_dialogue": "That's right. Same count, but bigger pieces win.",
  "error_path_generic": {
      "steps": [
        {
