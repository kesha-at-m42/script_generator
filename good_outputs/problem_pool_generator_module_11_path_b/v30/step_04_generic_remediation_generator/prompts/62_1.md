...
# Generated: 2026-02-19T17:37:16.879665
======================================================================
...

{
  ...
  "prompt": "Which TWO strategies can help you compare these fractions?",
  "interaction_tool": "multi_click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "reference", "description": "Fraction strip showing 3/4 shaded", "range": [0, 1], "intervals": "1/4", "shaded_intervals": 3}, {"id": "bar_b", "type": "fraction_strip", "role": "reference", "description": "Fraction strip showing 3/9 shaded", "range": [0, 1], "intervals": "1/9", "shaded_intervals": 3}, {"id": "comparison", "type": "math_expression", "role": "reference", "description": "Expression showing 3/4 > 3/9", "terms": ["3/4", ">", "3/9"]}, {"type": "choices", "options": [{"id": "a", "text": "Check for same numerator"}, {"id": "b", "text": "Compare the sizes of parts"}, {"id": "c", "text": "Look at the denominators only"}, {"id": "d", "text": "Count how many pieces are shaded"}], "allow_multiple": true}],
  "correct_answer": {"value": ["a", "b"], "context": "Same numerator means compare piece sizes - fourths are bigger than ninths"},
  "success_path_dialogue": "Right. Same numerator means you compare piece sizes.",
  "error_path_generic": {
      "steps": [
        {
