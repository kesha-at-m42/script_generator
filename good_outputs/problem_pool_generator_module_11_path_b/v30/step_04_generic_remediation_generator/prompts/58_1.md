...
# Generated: 2026-02-19T17:36:45.905357
======================================================================
...

{
  ...
  "prompt": "Which TWO steps of the strategy apply here?",
  "interaction_tool": "multi_click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "reference", "description": "Bar A divided into sevenths with 1 interval shaded", "range": [0, 1], "intervals": "1/7", "shaded_intervals": 1}, {"id": "bar_b", "type": "fraction_strip", "role": "reference", "description": "Bar B divided into sevenths with 6 intervals shaded", "range": [0, 1], "intervals": "1/7", "shaded_intervals": 6}, {"id": "expression_1", "type": "math_expression", "role": "reference", "description": "Comparison statement showing 1/7 < 6/7", "terms": ["1/7", "<", "6/7"]}, {"type": "choices", "allow_multiple": true, "options": [{"id": "a", "text": "Check for same denominator"}, {"id": "b", "text": "Compare the sizes of parts"}, {"id": "c", "text": "Count the equal parts"}, {"id": "d", "text": "Check for same numerator"}]}],
  "correct_answer": {"value": ["a", "c"], "context": "Both fractions have the same denominator (sevenths), so the strategy is to check that first, then count how many parts are shaded"},
  "success_path_dialogue": "Right. Same denominator means you count the parts.",
  "error_path_generic": {
      "steps": [
        {
