...
# Generated: 2026-02-19T17:36:55.050390
======================================================================
...

{
  ...
  "prompt": "Which TWO can help you compare these fractions?",
  "interaction_tool": "multi_click_choice",
  "workspace": [{"id": "bar_a", "type": "fraction_strip", "role": "reference", "description": "Fraction strip divided into sixths with 2 intervals shaded showing 2/6", "range": [0, 1], "intervals": "1/6", "shaded_intervals": 2}, {"id": "bar_b", "type": "fraction_strip", "role": "reference", "description": "Fraction strip divided into fourths with 2 intervals shaded showing 2/4", "range": [0, 1], "intervals": "1/4", "shaded_intervals": 2}, {"id": "expression_1", "type": "math_expression", "role": "reference", "description": "Math expression showing 2/6 < 2/4", "terms": ["2/6", "<", "2/4"]}, {"type": "choices", "allow_multiple": true, "options": [{"id": "a", "text": "Check for same numerator"}, {"id": "b", "text": "Compare the sizes of parts"}, {"id": "c", "text": "Check for same denominator"}, {"id": "d", "text": "Count the equal parts"}]}],
  "correct_answer": {"value": ["a", "b"], "context": "Both fractions have the same numerator (2), so comparing the sizes of the parts (sixths vs fourths) helps determine which fraction is larger"},
  "success_path_dialogue": "Right. Same numerator means you compare piece sizes.",
  "error_path_generic": {
      "steps": [
        {
