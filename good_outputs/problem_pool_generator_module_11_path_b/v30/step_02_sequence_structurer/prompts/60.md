...
# Generated: 2026-02-19T17:34:13.091746
======================================================================
...
- The student should know exactly what fraction to work with by reading only the prompt. It's still a problem though, so don't give away the answer. Make this decision based on the skill being tested here: Student can identify that a same-numerator pair requires the same-numerator strategy
...
**success_path_dialogue:** Rotate through the success_dialogue examples from the template here: ["Right. Same numerator means you compare piece sizes.", "Correct. Both show three pieces, so you check which pieces are bigger.", "Yes. You spotted the matching numerators.", "That's it. Same numerator, compare the sizes."]
