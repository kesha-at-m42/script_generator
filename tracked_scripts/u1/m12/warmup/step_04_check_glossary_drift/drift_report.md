...
| ---|---|--- |
| `No emphasis highlighting yet` | `s1_0_opening_hook_15_20_seconds` | ...isplayed centrally. No emphasis highlighting yet. |
...
| ---|---|---|---|--- |
| `arrays` | `"building"` | `visual` | `s1_0_opening_hook_15_20_seconds` | Arrays with Pictures (dot mode, neutral emphasis): A 2×7 dot |
...
### `s1_0_opening_hook_15_20_seconds`

- **Unresolved:** `No emphasis highlighting yet` in `visual`
  > ...isplayed centrally. No emphasis highlighting yet.
- **Deprecated alias:** `arrays` → `"building"` (in `visual`)
  > Arrays with Pictures (dot mode, neutral emphasis): A 2×7 dot array displayed centrally...
