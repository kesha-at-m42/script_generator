...
# Generated: 2026-04-20T11:56:37.817909
======================================================================
...
<input>
{
  ...
  "engagement_anchor": "Curiosity Gap (what's different about these two graphs?)",
  ...
  "correct_answer": "\"The scale-of-5 graph has fewer symbols\"",
  "on_correct": "\"Fewer symbols for the same data. When each symbol shows MORE, you need FEWER of them.\"",
  "design_note": "This is the conceptual payoff. Students SEE the efficiency before Lesson explains the mechanism (skip-counting).",
  "_generated_at": "2026-04-20T16:56:10.614019+00:00",
  "workspace_specs": {
    "toys": [
      "data_table",
      "picture_graph"
