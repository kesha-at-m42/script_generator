...
| ---|---|--- |
| `Minis characters appear in animated counting scenario` | `s1_1_data_collection_game` | Minis characters appear in animated counting scenario. |
...
- **Unresolved:** `Minis characters appear in animated counting scenario` in `visual`
