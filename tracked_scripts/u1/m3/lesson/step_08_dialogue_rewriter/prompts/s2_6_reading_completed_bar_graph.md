...
<input>
{
  ...
  "dialogues": [
    ...
    {
      "text": "5 symbols. Count by 5s: 5, 10, 15, 20, 25. There are 5 fives. Bar graph and picture graph: same information, different format.",
      "context": "on_correct"
    }
  ]
}
...
{"id": "s2_6_reading_completed_bar_graph", "dialogues": [
