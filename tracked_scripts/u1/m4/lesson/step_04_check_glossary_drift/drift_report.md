...
| ---|---|--- |
| `Vertical layout` | `s3_5_final_challenge_create_analyze` | ...rrots=45, Beans=20. Vertical layout. |
...
- **Unresolved:** `Vertical layout` in `visual`
  > ...rrots=45, Beans=20. Vertical layout.
