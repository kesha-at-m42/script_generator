...
| `Build Mode Interface` | `s1_4_student_builds_notation_shown_build` | Build Mode Interface. Empty workspace initially. |
| `Empty workspace initially` | `s1_4_student_builds_notation_shown_build` | ...ild Mode Interface. Empty workspace initially. |
...
| ---|---|--- |
| `multiple_choice` | `s2_2_reduced_scaffolding_product_introduction` | "How many groups? How many in each?" |
