...
<input>
{
  ...
  "beats": [
    ...
    },
    {
      ...
      "id": "s3_1_real_world_bridge_equal_groups_b1"
    },
    {
      "type": "current_scene",
      "elements": [
      ...
      "validator": [
        {
          ...
          "description": "Student set 4 containers, correct",
          "is_correct": true,
          "beats": [
            {
              "type": "dialogue",
      ...
      "validator": [
        {
          ...
          "description": "Student set 6 items per container, correct",
          "is_correct": true,
          "beats": [
            {
              "type": "dialogue",
...
{"id": "s3_1_real_world_bridge_equal_groups", "incorrects": [
