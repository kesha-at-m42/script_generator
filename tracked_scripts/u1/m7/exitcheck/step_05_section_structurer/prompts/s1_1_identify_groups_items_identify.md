...
# Generated: 2026-04-27T10:52:58.253407
======================================================================
...
<input>
{
  ...
  "student_action": "Identify groups and items (independently or with light support).",
  "correct_answer": "3 groups, 5 in each.",
  "answer_rationale": "5 = Correct (5 markers in each box)\n3 = Error: Said number of groups instead of items per group (#10 confusion)\n8 = Error: Added groups + items\n15 = Error: Said total items instead of items per group",
  "on_correct": "\"5 markers in each box. 3 groups of 5.\"",
  "on_incorrect": "\"Look inside ONE box. Count the markers.\"",
  ...
  "_generated_at": "2026-04-27T15:52:34.354062+00:00",
  "workspace_specs": {
    "toys": [
      "equal_groups"
    ],
