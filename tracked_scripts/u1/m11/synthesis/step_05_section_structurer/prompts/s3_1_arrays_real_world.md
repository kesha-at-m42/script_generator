...
# Generated: 2026-04-10T11:50:44.465820
======================================================================
...
<input>
{
  ...
  "student_action": "Multi-select MC (student selects all that apply)",
  "correct_answer": "A, B, D (all three are arrays; C is not)",
  "on_correct": "(all three selected) \"Egg carton, parking lot, window pane — arrays are everywhere. Same rows and columns structure you've been working with.\"",
  "on_partially_correct": "(missed one or selected C) \"Arrays have everything lined up in rows and columns. The marbles are scattered — no rows, no columns, not an array. Look for all that are  lined up in a rectangle.\"",
  ...
  "_generated_at": "2026-04-10T16:49:49.158927+00:00",
  "workspace_specs": {
    "toys": [],
    "tools": [
      "multi_select"
