...
# Generated: 2026-03-06T14:53:43.046173
======================================================================
  ...
  "steps": [
    [
      ...
      },
      {
        "type": "scene",
        "method": "add",
        "tangible_id": "data_table_animals_full",
        ...
        "params": {
          ...
          "description": "Data table appears in symbol display mode. Animals We Saw context, 4 categories, horizontal. Values: Squirrels=10, Deer=6, Birds=7, Rabbits=8. Symbols show grouping by 2s."
        }
      },
      {
        "type": "scene",
        ...
        "params": {
          ...
          "description": "Empty picture graph template appears, horizontal. 2 of 4 categories pre-filled: Squirrels=5 symbols, Deer=3 symbols. Birds and Rabbits rows empty. Key: Each ⭐ = 2."
        }
      },
      {
        "type": "dialogue",
        "text": "Now you place the symbols to show 7 Bird sightings. Remember: 7 needs 3 full symbols and 1 half-symbol."
      },
      {
        "type": "prompt",
        ...
        "validator": [
          {
            ...
            "description": "Student placed 3.5 symbols for Birds — correct",
            "is_correct": true,
            "steps": [
              [
                {
                ...
                },
                {
                  ...
                  "elements": [
                    {
                      "tangible_id": "data_table_animals_full",
                      "description": "Data table in symbol display mode showing Animals We Saw values.",
                      "tangible_type": "data_table",
                      "display_mode": "symbol",
                      "categories": [
                        "Squirrels",
                    ...
                    {
                      "tangible_id": "picture_graph_animals_create",
                      "description": "Horizontal picture graph. Squirrels and Deer pre-filled. Birds now filled with 3.5 symbols (student created). Rabbits empty.",
                      "tangible_type": "picture_graph",
                      "mode": "creating",
                      "orientation": "horizontal",
                      "scale": 2,
      ...
      },
      {
        ...
        "elements": [
          {
            "tangible_id": "data_table_animals_full",
            "description": "Data table in symbol display mode showing all Animals We Saw values.",
            "tangible_type": "data_table",
            "display_mode": "symbol",
            "categories": [
              "Squirrels",
          ...
          {
            "tangible_id": "picture_graph_animals_create",
            "description": "Horizontal picture graph in creating mode. Squirrels and Deer pre-filled. Birds row empty awaiting placement. Rabbits row empty.",
            "tangible_type": "picture_graph",
            "mode": "creating",
            "orientation": "horizontal",
            "scale": 2,
