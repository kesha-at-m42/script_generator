...
# Generated: 2026-03-06T14:53:01.516176
======================================================================
    ...
    [
      {
        ...
        "params": {
          ...
          "description": "Crackers (7 symbols) and Popcorn (4 symbols) highlighted for comparison."
        }
      },
      {
        "type": "dialogue",
        ...
        "validator": [
          {
            ...
            "description": "Student answered 6 — correct (14 - 8 = 6)",
            "is_correct": true,
            "steps": [
              [
                {
                ...
                },
                {
                  ...
                  "elements": [
                    {
                      "tangible_id": "picture_graph_snacks",
                      "description": "Vertical picture graph. Crackers and Popcorn highlighted. Comparison of 14 vs 8 confirmed as difference of 6.",
                      "tangible_type": "picture_graph",
                      "mode": "reading",
      ...
      },
      {
        ...
        "elements": [
          {
            "tangible_id": "picture_graph_snacks",
            "description": "Vertical picture graph. Crackers (7 symbols) and Popcorn (4 symbols) highlighted. Multiple choice options for difference visible.",
            "tangible_type": "picture_graph",
            "mode": "reading",
            "orientation": "vertical",
            "scale": 2,
...
{"id": "s1_7_how_many_more", "incorrects": [
