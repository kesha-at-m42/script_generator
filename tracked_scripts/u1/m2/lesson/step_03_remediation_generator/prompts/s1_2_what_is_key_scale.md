...
# Generated: 2026-03-06T14:51:53.198210
======================================================================
    ...
    [
      {
        ...
        "params": {
          ...
          "description": "Key area highlighted showing 'Each ⭐ = 2'."
        }
      },
      {
        "type": "dialogue",
      ...
      {
        "type": "dialogue",
        "text": "Scale of 1 means each symbol shows 1 item. So what does scale of 2 mean?"
      },
      {
        "type": "prompt",
        ...
        "validator": [
          {
            ...
            "description": "Student selected 'Each symbol shows 2 items' — correct definition of scale",
            "is_correct": true,
            "steps": [
              [
                {
                ...
                },
                {
                  ...
                  "elements": [
                    {
                      "tangible_id": "picture_graph_warmup",
                      "description": "Horizontal picture graph with key highlighted. Scale of 2. Student correctly identified scale meaning.",
                      "tangible_type": "picture_graph",
                      "mode": "reading",
      ...
      },
      {
        ...
        "elements": [
          {
            "tangible_id": "picture_graph_warmup",
            "description": "Horizontal picture graph with key area highlighted. Scale of 2. Multiple choice options visible for scale meaning.",
            "tangible_type": "picture_graph",
            "mode": "reading",
            "orientation": "horizontal",
            "scale": 2,
...
{"id": "s1_2_what_is_key_scale", "incorrects": [
