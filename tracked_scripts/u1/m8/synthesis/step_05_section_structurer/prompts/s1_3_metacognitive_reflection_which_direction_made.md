...
<input>
{
  ...
  "purpose": "Help students identify which aspect of expression-building made the most sense to them. Builds metacognitive awareness about their own learning process.",
  ...
  "student_action": "Multiple Choice selection (all responses validated equally).",
  ...
  "correct_answer": "Any selection (no wrong answer in reflection)",
  "on_selection_a": "\"Building from pictures lets you see where the numbers come from. That's a strong way to learn.\"",
  "on_selection_b": "\"Working backwards—from expression to picture—shows you what expressions MEAN. That's powerful too.\"",
