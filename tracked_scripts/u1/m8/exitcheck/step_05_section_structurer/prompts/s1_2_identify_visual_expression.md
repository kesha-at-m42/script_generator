...
# Generated: 2026-04-27T10:53:18.501675
======================================================================
...
<input>
{
  ...
  "student_action": "Multiple Choice selection (click visual).",
  "options": "A: 4 bags of 2 ✓, B: 2 bags of 4 (reversal), C: 6 items scattered (sum of factors)",
  "correct_answer": "A",
  "on_correct": "\"That's right—4 groups with 2 in each.\"",
  "remediation": "Pipeline",
  "_generated_at": "2026-04-27T15:52:42.675764+00:00",
  "workspace_specs": {
    "toys": [
      "equal_groups",
      "equation_builder"
