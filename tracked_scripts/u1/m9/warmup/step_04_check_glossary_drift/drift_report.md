...
| ---|---|---|---|--- |
| `template` | `Toys` | `visual` | `s1_1_expression_callback_activation` | ...ide with expression template: `[___] × [___]` (two slots, |
...
### `s1_1_expression_callback_activation`

- **Deprecated alias:** `template` → `Toys` (in `visual`)
  > ...ide with expression template: `[___] × [___]` (two slots, no = sign — M8 format).
