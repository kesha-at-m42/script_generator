...
# Generated: 2026-04-20T12:05:07.259660
======================================================================
...
<input>
{
  ...
  "on_overshoot": "(e.g., 5 groups of 10 \\= 50)",
  ...
  "on_correct_total_unequal_groups": "\"You hit 10\\. But check — are the groups equal? Multiplication needs equal groups. Adjust so each group has the same number.\"",
  "on_equal_groups_wrong_total": "\"Equal groups — great\\! But the total isn't 10\\. Add more to each group (or remove some) and watch the total.\"",
  "guide_6": "\"Your turn with a different one. 2 groups, 14 total. 2 times what equals 14?\"",
  "prompt_3": "\"2 × ☐ \\= 14\\. How many in each group?\"",
  "student_action_3": "Uses \\+/- to add items to individual groups. Running total updates live.",
  "correct_answer": "`7`",
  "on_correct_3": "(2 equal groups of 7, total \\= 14)",
  "visual_4": "7 cats appear in each group. Equation completes: `2 × 7 = 10`.",
  "guide_7": "\"2 times 7 equals 14\\. 2 groups of 7 is 14\\. You built the answer.\"",
  "visual_5": "Reversed form: `14 = 2 × 7`.",
  "on_correct_total_unequal_groups_2": "\"You hit 14\\. But check — are the groups equal? Multiplication needs equal groups. Adjust so each group has the same number.\"",
  "on_equal_groups_wrong_total_2": "\"Equal groups — great\\! But the total isn't 14\\. Add more to each group (or remove some) and watch the total.\"",
  ...
  "_generated_at": "2026-04-20T17:01:34.045951+00:00",
  "workspace_specs": {
    "toys": [
      "equal_groups",
      "equation_builder"
