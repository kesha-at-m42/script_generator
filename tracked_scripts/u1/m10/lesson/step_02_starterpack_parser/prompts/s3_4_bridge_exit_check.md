...
# Generated: 2026-04-27T10:54:14.083943
======================================================================
...
<input>
{
  ...
  "major": 3,
  "minor": 4,
  "slug": "bridge_exit_check",
  "header": "### **Bridge to Exit Check**",
  "body": "- **Guide:** \"You built equations with bags, rows, stacks, and groups. You found unknown numbers in different positions. Let's see what you know.\"\n- **No student action** (transition)\n**Voice Note:** Brief. References what student DID (built equations, found unknowns), not what they should feel. Matches playbook transition formula: \"You've got the idea. Let's see what you know.\"\n---"
}
</input>
