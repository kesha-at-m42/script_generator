...
| ---|---|--- |
| `Clean display` | `s4_2_key_takeaway` | Clean display. No equations visible (reflective space). |
| `No equations` | `s4_2_key_takeaway` | Clean display. No equations visible (reflective space). |
...
- **Unresolved:** `Clean display` in `visual`
  > Clean display. No equations visible (reflective space).
- **Unresolved:** `No equations` in `visual`
  > Clean display. No equations visible (reflective space).
