...
# Generated: 2026-04-29T14:28:33.929281
======================================================================
...
<input>
{
  ...
  "tutor_narration_student_facing": "\"In the last lesson, you built a rectangle with 4 square tiles in each row and 5 rows. You checked it and saw that the area was 20 square tiles. Today you will look at that same rectangle again — and learn two different ways to write what you already know about it. The equal sign is the key. Let's look at what it really means.\"",
  "divider": "*(Purpose Frame delivers the curiosity gap and context. No student action. No vocabulary-fence term. No equation display before W.1 Check.)*\n\n---\n\n### Section 1: CONCRETE (L.1)\n\n*(Note: W.1 is now hosted in §1.6 WARMUP per skeleton compliance; §1.7 Section 1 begins with L.1.)*",
  "_generated_at": "2026-04-29T19:28:05.151408+00:00",
  "workspace_specs": {
    "toys": [],
