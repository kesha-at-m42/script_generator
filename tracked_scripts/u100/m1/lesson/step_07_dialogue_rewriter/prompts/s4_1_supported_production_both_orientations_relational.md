...
# Generated: 2026-04-29T14:30:36.623896
======================================================================
...
<input>
{
  ...
  "dialogues": [
    {
      "text": "This rectangle lets you write the same fact in two ways. Finish the sentence using the numbers from both panels.",
      "context": "lesson"
    },
    {
      "text": "You wrote both of them. 4 × 5 = 20 and 20 = 4 × 5 — the same fact, two ways. The equal sign means both sides have the same value.",
      "context": "on_correct"
    }
  ]
}
...
{"id": "s4_1_supported_production_both_orientations_relational", "dialogues": [
