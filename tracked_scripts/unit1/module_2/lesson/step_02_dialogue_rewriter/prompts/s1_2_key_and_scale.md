...
# Generated: 2026-03-09T12:05:42.940439
======================================================================
...
<input>
{
  "id": "s1_2_key_and_scale",
  "scene": [
    "picture_graph_warmup",
    "data_table"
  ],
  "steps": [
    [
      {
        ...
        "params": {
          ...
          "description": "Key area highlighted showing 'Each star = 2'."
        }
      },
      {
        "type": "dialogue",
        "text": "Every graph has a KEY. The key is like a decoder. It tells you what each symbol MEANS."
      },
      {
        "type": "dialogue",
        "text": "This key says: each star equals 2. That 2 is called the SCALE."
      },
      {
        "type": "dialogue",
        "text": "Scale of 1 means each symbol represents 1 item. So what does scale of 2 mean?"
      },
      {
        "type": "prompt",
        "text": "This graph has a scale of 2. What does that mean?",
        "tool": {
        ...
        "validator": [
          {
            "condition": {
              "selected": "Each symbol shows 2 items"
            },
            "description": "Student selected correct definition of scale of 2",
            "is_correct": true,
            "steps": [
              [
                {
                  "type": "dialogue",
                  "text": "Scale of 2 means each symbol represents 2 items. The KEY tells you the scale. Always check the key first."
                },
                {
                  "type": "current_scene",
                  "elements": [
                    {
                      "tangible_id": "picture_graph_warmup",
                      "description": "Horizontal scaled picture graph. Key highlighted showing scale of 2.",
                    ...
                    },
                    {
                      ...
                      "description": "Data table visible alongside graph.",
      ...
      },
      {
        ...
        "elements": [
          {
            "tangible_id": "picture_graph_warmup",
            "description": "Horizontal picture graph with key highlighted. Multiple choice prompt active.",
            "tangible_type": "picture_graph",
            "mode": "reading",
            "orientation": "horizontal",
            "scale": 2,
          ...
          {
            "tangible_id": "data_table",
            "description": "Data table visible.",
            "tangible_type": "data_table",
            "display_mode": "numeric"
          }
        ]
...
{"id": "s1_2_key_and_scale", "dialogues": [
