...
| `Simple text screen` | `s4_1_bridge_to_lesson` | Simple text screen. Reference to the three contexts just experienced. |
| `Reference to the three contexts just experienced` | `s4_1_bridge_to_lesson` | Simple text screen. Reference to the three contexts just experienced. |
