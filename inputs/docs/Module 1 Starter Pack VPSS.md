...
**Callback to Grade 2:**  
 "Previously in school, you’ve seen shapes divided into parts.  You might have noticed patterns in how shapes could be split."

**Setup for Module 2:**  
 "Now that you understand equal parts of a whole you're ready to name those parts. In math, we call parts of a whole “fractions.”. Together, we’ll explore how to identify just one part."
...
|  | "fraction" | After multiple examples of equal parts: "These equal parts can be named with FRACTIONS \- the word we use for equal parts out of one whole." |
...
* NO open-ended questions requiring student answers \- use selection or action tasks  
...
* **Hook:** "Let’s look at these tile arrangements \- which shows equal groups?" \[Show pre-arranged options\]  
...
* **Tone:** Curious, exploratory; "Let's explore..." "What do you notice?"  
* **Pacing:** Allow 10-15 seconds for visual scanning; pause after questions  
* **Energy:** Calm but engaged; emphasis on visual discovery

---

#### WARMUP PHASE COVERAGE CHECKLIST

Before finalizing Warmup, verify:

**Structure:**   
☐ Hook present in first 15-20 seconds   
☐ 2-3 visual interactions (not just clicking "next")   
☐ Bridge to Lesson at end (creates anticipation)   
☐ Total time under 4 minutes

**Content:**   
☐ Prior knowledge activated (equal parts from Grade 2\)   
☐ At least one judgment/noticing task ("Which shows...?" or "What do you notice...?")   
☐ Visual comparison opportunity (equal vs. unequal)

**Tools:**   
☐ Grid rectangles introduced informally (no \[Tool\_Intro\] yet—save for Lesson)   
☐ Pre-divided shapes shown (students identify, not create)

**Vocabulary:**   
☐ "equal" used naturally (not formally introduced)   
☐ "parts" used naturally (not formally introduced)   
☐ NO formal terms: partition, fraction, whole, halves, thirds, etc.

**Constraints Verified:**   
☐ No fraction notation (1/2, 1/4, etc.)   
☐ No formal vocabulary introduction   
☐ No teaching of new concepts (activation only)   
☐ Cognitive load stays light (20-30%)

**Voice (Path C):**   
☐ Curious, exploratory tone   
☐ "What do you notice?" framing   
☐ Pattern-focused language
...
| **Guide Framing**  | "Look at this shape. Before we divide it, this is one whole \- all of it together \- is what we're starting with."  |
...
| **Check** | "You made \[X\] equal parts." After shading: "You shaded one part \- that's one \[fraction word\]." If verification needed, use selection task: "Click the number that shows how many equal parts" \[2\] \[3\] \[4\] |
...
| **Example** | Thirds (1x3 grid): Partition: "Try making three equal parts" Shade: "Please shade one part" Name: "That's one THIRD" Pattern Prompt: "You've made halves, fourths, thirds \- do you notice a pattern in how these parts are named?" Sixths (2x3 OR 3x2 grid \- AREA-BASED): Strategy: "First split in half, then split each half into three" (explicit demonstration) Partition: Student creates 2x3 array Shade: "Please shade one part" Name: "That's one SIXTH" Check: "Let’s count all the grid units \- six equal parts" VPSS Advantage: 2D grid shows sixths as spatial arrangement (2 rows × 3 columns), not just linear division Eighths (2x4 OR 4x2 grid): Strategy: "Start with halves, then fourths, then eighths" (repeated halving shown) Partition: Student creates 2x4 array Shade: "Can you shade one part?" Name: "That's one EIGHTH" Pattern Recognition: "What happens when we double the number of  parts? The pieces get smaller. |
| **Vocabulary** | Introduce "equal parts" formally after multiple experiences |
| **Language Pattern Discovery** | "Let’s look at the words \- halves, thirds, fourths, sixths, eighths \- they describe how many parts" |
| **Check** | "You made \[X\] equal parts. One of those parts is one \[fraction word\]." For active verification: "Click how many equal parts you see" \[3\] \[4\] \[6\] or "Select what we call one of these parts" \[third\] \[fourth\] \[sixth\]  |
...
| **Key Bridge** | "You've been saying 'one-fourth' \- mathematicians can write ‘one-fourth’ using numbers" |
...
| **Vocabulary** | Introduce "fractions": \[Vocabulary\_Staging\] "These equal parts can be named with FRACTIONS \- numbers that show parts of a whole" |
| **Application (2-3 examples on grids):** | Example 1: Show partitioned thirds with one shaded → "We've been calling this 'one-third' \- now we write 1/3" Example 2: "Please partition a grid into sixths andshade one part" → Student partitions and shades → Guide: "What fraction is shaded?" → "1/6" Example 3: Show multiple grids (halves, fourths, eighths) → "Match the notation: which shows 1/2? which shows 1/8?" |
...
| **Transfer Challenge** | "You've worked with grids. Can you show equal parts on a hexagon?" |
...
| **Sequence for Each (Full Skill)** | Partition: "Can you make  \[X\] equal parts on this hexagon?" Shade: "Please shade one part" Name WITH notation: "What fraction is shaded?" → "1/3" Verify: "When we count the sides, are the sections equal?" |
...
#### LESSON PHASE COVERAGE CHECKLIST

Before finalizing Lesson, verify:

**Fractions (all 5 required):**   
☐ Halves (1/2) — Section 1, first partition   
☐ Fourths (1/4) — Section 1, before eighths   
☐ Eighths (1/8) — Section 1, doubling pattern completion   
☐ Thirds (1/3) — Section 1, new pattern   
☐ Sixths (1/6) — Section 1, 2D grid emphasis

**Notation Introduction (Section 2):**   
☐ At least one fraction shown in symbolic form (e.g., 1/4)   
☐ Top/bottom number meaning explained   
☐ Connection made: "You've been saying X—here's how we write it"

**Shape Coverage:**   
☐ Grid Arrays (1D): At least 2 different configurations   
☐ Grid Arrays (2D): At least 1 configuration (2x3 or 2x4)   
☐ Hexagons: At least 2 partition types (from: halves, thirds, sixths)

**Vocabulary Staged (in order):**   
☐ "whole" — Section 1, Critical Moment 1   
☐ "partition" — Section 1, after first partition action   
☐ "equal parts" — Section 1, after multiple partition experiences   
☐ "fraction" — Section 2, with notation bridge

**Misconceptions Addressed:**   
☐ M1.1 (Unequal Parts) — At least one remediation path   
☐ M1.2 (Misidentifying Whole) — Prevention in Critical Moment 1

**Tools Introduced:**   
☐ Grid Arrays with \[Tool\_Intro\] tag — Section 1   
☐ Partition/Eraser tool demonstrated — Critical Moment 2   
☐ Hexagons with \[Tool\_Intro\] tag — Section 3

**Structural:**   
☐ Minimum 6 interactions total   
☐ Immediate shading after every partition   
☐ Visual verification prompt after each new fraction type  
---
...
* **Say:** "Let's see if you're ready to put these ideas into practice."  
...
#### EXIT CHECK COVERAGE CHECKLIST

Before finalizing Exit Check, verify:

**Structure:**   
☐ 1-2 minutes total   
☐ Clear transition from Lesson: "Let's see if you're ready..." 

**Content:**   
☐ Tests EXACT Lesson content (no new concepts)   
☐ Visual identification format (not creation)   
☐ 3-4 options shown (some equal, some unequal partitions)   
☐ At least one option with unequal parts (tests M1.1)

**Alignment:**   
☐ Uses same visual tools as Lesson (grid rectangles or shapes from Lesson)   
☐ Fraction types match what was taught (not all 5 required—just what was covered)   
☐ Difficulty matches end-of-Lesson level

**Remediation:**   
☐ Brief re-teach path for incorrect response   
☐ Does NOT require full L-M-H remediation (this is a gate, not practice)

**Constraints Verified:**   
☐ No new tools introduced   
☐ No new fraction types beyond Lesson   
...
* **Bridge:** "You’re showing that you understand equal parts. Now you'll practice creating them and recognizing them in different shapes."  
* **Identity Builder:** "You’re identifying visual patterns that will help you see when parts are equal."  
...
* **Creation:** "Can you partition this rectangle into 6 equal parts?" \[Using tools\]  
* **Application:** "Try fixing this unequal partition" \[Problem-solving\]
...
* **Tone:** Supportive but allowing independent work; "Now, you can try our strategy yourself."  
* **Support:** Grid scaffolding available; overlay comparison tool if needed  
* **Celebration:** "You created equal parts\!"

---

#### PRACTICE PHASE COVERAGE CHECKLIST

Before finalizing Practice, verify:

**Distribution:**   
☐ 40% Recognition questions (4 of 10\)  
 ☐ 40% Creation questions (4 of 10\)   
☐ 20% Application questions (2 of 10\)

**Fraction Coverage:**   
☐ Halves — At least 2 problems   
☐ Thirds — At least 2 problems   
☐ Fourths — At least 2 problems   
☐ Sixths — At least 1 problem   
☐ Eighths — At least 1 problem

**Tool Coverage:**   
☐ Grid arrays (primary tool)   
☐ Hexagons (at least 1-2 problems)   
☐ Partition drawing tool (for Creation questions)   
☐ Pattern tiles for identification (optional)

**Misconception Coverage:**   
☐ M1.1 (Unequal Parts) — At least 2 problems require rejecting unequal options   
☐ M1.2 (Misidentifying Whole) — At least 1 problem emphasizes whole identification

**Remediation:**   
☐ Full L-M-H remediation for every prompt   
☐ Variety: 8+ different Light remediation patterns across phase   
☐ "Remember" used maximum 2-3 times total   
☐ Path C interventions used (visual verification, overlay comparison)

**Constraints Verified:**   
☐ All problems align to specific Lesson content   
☐ No new concepts introduced   
☐ No fraction comparison (Module 10+)   
☐ No notation beyond what was taught in Lesson Section 2

**Voice:**   
☐ Brief, task-focused   
☐ Specific feedback referencing observable actions   
☐ Reserve warmth for genuine achievements  
---
...
**Core Takeaway:**  
 "You learned that we describe parts of a whole using fractions. The key is that, for fractions to work, all parts must be exactly the same size."

**Identity Moment:**  
 "When you check that parts are equal by counting grid units or overlaying tiles, you're using visual proof to solve problems. Mathematicians use these strategies, too."
...
* **Module Bridge:** Path C setup language: "Now that you understand equal parts and wholes, you're ready to name specific parts with fractions. You'll discover how to identify 'one part' using your visual pattern skills."
...
#### SYNTHESIS PHASE COVERAGE CHECKLIST

Before finalizing Synthesis, verify:

**Structure:**   
☐ Core takeaway stated (equal parts requirement)   
☐ Identity moment present (connects to mathematical thinking)   
☐ Module bridge to Module 2 (previews unit fraction naming)

**Core Takeaway Must Include:**   
☐ "Fractions require exactly equal parts" concept   
☐ Reference to student's work today (not generic)

**Identity Moment Must Include:**   
☐ Path C framing (visual proof, pattern recognition)   
☐ Connection to mathematical practices ("Mathematicians use...")   
☐ Specific, not generic praise

**Module Bridge Must Include:**   
☐ Callback to what was learned (equal parts, whole, partition)   
☐ Preview of Module 2 (naming unit fractions, "one part")   
☐ Confidence framing ("You're ready because...")

**Vocabulary:**   
☐ Uses all introduced terms naturally: whole, partition, equal parts, fraction   
☐ Does NOT introduce new terms

**Constraints Verified:**   
☐ No new teaching   
☐ No assessment   
☐ Reflective/celebratory tone, not instructional

**Voice (Path C):**   
☐ Reflective, warm   
☐ Emphasis on visual/spatial discovery accomplished   
☐ Slower pacing for processing  
---
