...
def split_by_difficulty(input_file):
    ...
    difficulty_names = {0: "support", 1: "confidence", 2: "baseline", 3: "stretch", 4: "challenge"}
    ...
    for seq in sequences:
        ...
        if difficulty in difficulty_groups:
            ...
            print(
                f"⚠️  Unknown difficulty: {difficulty} in problem_id {seq.get('metadata', {}).get('problem_id', seq.get('problem_id'))}"
            )
    ...
    for level, items in difficulty_groups.items():
        ...
        output_data = {"@type": "SequencePool", "sequences": items}
...
def split_by_verb(input_file):
    ...
    for seq in sequences:
        ...
        if verb:
            ...
            print(
                f"⚠️  No verb found in problem_id {seq.get('metadata', {}).get('problem_id', seq.get('problem_id'))}"
            )
