# ── V3 / Phase 8 skeleton ────────────────────────────────────────────────────
# Derived from: section_structurer.py
# For use with: *_generator_v3 pipelines (unit100+ Phase 8 skeleton format)
# ─────────────────────────────────────────────────────────────────────────────
"""
section_structurer_v3 - AI Prompt

Converts a structured spec (output of starterpack_parser_v3) into section JSON
objects following the lesson script schema (sections / steps / beats).
...
SECTION_STRUCTURER_V3_PROMPT = Prompt(
