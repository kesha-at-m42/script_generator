...
- problem_id, step_index, mastery_tier, verb, template_id, fractions
...
- ALL original fields from input (problem_id, step_index, mastery_tier, verb, template_id, fractions, dialogue, prompt, interaction_tool, workspace, correct_answer, success_path_dialogue)
...
""",
    ...
    prefill='''[{"problem_id":{problem_id},"step_index":{step_index},"mastery_tier":"{mastery_tier}","verb":"{verb}","template_id":"{template_id}","fractions":{fractions},"dialogue":"{dialogue}","prompt":"{prompt}","interaction_tool":"{interaction_tool}","workspace":{workspace},"correct_answer":{correct_answer},"success_path_dialogue":"{success_path_dialogue}","error_path_generic":''',
